...
export default function CustomerSearchInput({
  ...
  const { data: customerAddresses = [] } = useQuery({
    queryKey: [`/api/addresses?customerId=${value?.id || 0}`],
    enabled: !!value?.id,
  });
                ...
                <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-hidden flex flex-col">
                  ...
                  <div className="grid gap-6 py-4 overflow-y-auto flex-1 pr-2">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex flex-col gap-3">
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            checked={newCustomer.preferredCommunicationMethod.includes(
                              'email'
                            )}
                            onCheckedChange={(checked) => {
                              const methods =
                                newCustomer.preferredCommunicationMethod;
                              setNewCustomer((prev) => ({
                                ...prev,
                      ...
                      {newCustomer.preferredCommunicationMethod.length ===
                        0 && (

...
-   **Core Features**:
    ...
    -   **Department Manager**: Enhanced navigation with separate "Shipping QC" and "Shipping" department options. Features CSS-based hover tooltips that display comprehensive order details including all customizations and features without glitching or performance issues.

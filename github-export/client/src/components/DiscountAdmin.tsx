...
export default function DiscountAdmin({ onSalesChange }: DiscountAdminProps) {
  ...
  const createMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Success',
        description: 'Short-term sale created successfully',
      });
    },
    onError: () => {
      toast({
        title: 'Error',
        description: 'Failed to create short-term sale',
        variant: 'destructive',
      });
    },
  });
  ...
  const updateMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({
        title: 'Success',
        description: 'Short-term sale updated successfully',
      });
    },
    onError: () => {
      toast({
        title: 'Error',
        description: 'Failed to update short-term sale',
        variant: 'destructive',
      });
    },
  });
  ...
  const deleteMutation = useMutation({
    ...
    onError: () => {
      toast({
        title: 'Error',
        description: 'Failed to delete short-term sale',
        variant: 'destructive',
      });
    },
  });
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  value={formSale.name}
                  onChange={(e) =>
                    setFormSale({ ...formSale, name: e.target.value })
                  }
              ...
              <div>
                ...
                <Select
                  value={formSale.appliesTo}
                  onValueChange={(value) =>
                    setFormSale({ ...formSale, appliesTo: value })
                  }
                >
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormSale({ ...formSale, startDate: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    setFormSale({ ...formSale, endDate: e.target.value })
                  }
                  className="mt-1"
                />
              </div>
                  ...
                  sales.map((sale) => {
                    ...
                    return (
                      <TableRow key={sale.id}>
                        ...
                        <TableCell>
                          {sale.appliesTo === 'stock_model'
                            ? 'Stock Model Only'
                            : 'Total Order'}
                        </TableCell>
                        <TableCell>
                          {format(new Date(sale.startDate), 'yyyy-MM-dd')}
                        </TableCell>
                        <TableCell>
                          {format(new Date(sale.endDate), 'yyyy-MM-dd')}
                        </TableCell>
                        <TableCell>

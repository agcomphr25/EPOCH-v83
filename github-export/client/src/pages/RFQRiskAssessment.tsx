...
export default function RFQRiskAssessment() {
  ...
  const validateForm = () => {
    if (
      ...
      alert(
        'All Mitigation Actions are required. Please fill in all three mitigation action fields.'
      );
      return false;
    }
    return true;
      ...
      <div className="max-w-4xl mx-auto ml-16">
        ...
        <Card className="mb-6">
          <CardHeader>
            ...
            <p className="text-sm text-gray-600">
              All mitigation actions are required. Enter numeric values to
              reduce overall risk level.
            </p>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="flex gap-4 items-start">
              <div className="flex-1">
                <Label htmlFor="mitigationA" className="text-red-500">
                  a. * (Required)
                </Label>
                <Textarea
                  id="mitigationA"
            ...
            <div className="flex gap-4 items-start">
              <div className="flex-1">
                <Label htmlFor="mitigationB" className="text-red-500">
                  b. * (Required)
                </Label>
                <Textarea
                  id="mitigationB"
            ...
            <div className="flex gap-4 items-start">
              <div className="flex-1">
                <Label htmlFor="mitigationC" className="text-red-500">
                  c. * (Required)
                </Label>
                <Textarea
                  id="mitigationC"

  ...
  const questions = [
    {
      id: 'q1',
      question:
        'What is the primary concern when dealing with counterfeit materials in manufacturing?',
      options: [
    ...
    },
    {
      id: 'q2',
      question:
        'Which of the following is a key indicator of potentially counterfeit parts?',
      options: [
    ...
    },
    {
      id: 'q4',
      question:
        'What is the best practice for verifying supplier authenticity?',
      options: [
    ...
    },
    {
      id: 'q5',
      question:
        'Which documentation should be carefully inspected for counterfeits?',
      options: [
    ...
    },
    {
      id: 'q6',
      question:
        'What should you do if you discover counterfeit materials after they have been used in production?',
      options: [
      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-between mb-6 print:hidden">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              onClick={handleGenerateAnswerKeyPDF}
              variant="outline"
              className="flex items-center gap-2"
            >
          ...
          <Card className="mb-8">
            ...
            <CardContent className="space-y-8">
              ...
              <div>
                ...
                <p className="mb-3">
                  Counterfeiting is growing in exponential proportions with
                ...
                <p className="mt-3 text-sm text-gray-700">
                  If this threat is not adequately addressed, counterfeit items
                  have the potential to seriously compromise the safety and
                  operational effectiveness of our products.
                </p>
              </div>
              ...
              <div>
                ...
                <ol className="list-decimal pl-6 space-y-1">
                  <li>
                    The risks and impacts of counterfeit parts infiltrating the
                    supply chain
                  </li>
                  <li>Best practices to eliminate or mitigate those risks</li>
                  <li>
                    The AG Composites counterfeit prevention requirements for
                    suppliers
                  </li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ol className="list-decimal pl-6 space-y-2">
                  <li>
                    Procuring directly from the Original Component or Equipment
                    manufacturer (OCM/OEM) is the lowest risk.
                  </li>
                  <li>
                    OCM Authorized Distributors are the next lowest risk.
                    <ol className="list-[lower-alpha] pl-6 mt-1 space-y-1">
                      <li>
                        OCM Authorized distributors have documented sales
                        agreements with manufacturers.
                      </li>
                      <li>
                        Inventory manager should verify authorized distributor
                        status with the manufacturer.
                      </li>
                    </ol>
                  </li>
                  <li>
                    AG POs require suppliers to use OCMs or their authorized
                    sources for products that will be delivered to Lockheed
                    Martin.
                  </li>
                </ol>
              </div>
              ...
              <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500">
                ...
                <div className="text-sm">
                  <strong>PREVENTION OF COUNTERFEIT PARTS:</strong> Suppliers
                  shall ensure through their processes and/or a formal program
                  against the receipt of counterfeit materials into their
                  inventory, against their use in manufacturing, and against
                  their being sold to other suppliers. Supplier shall not
                  deliver counterfeit work or suspect counterfeit work to AG
                  Advanced Technologies. All parts and materials shall be
                  procured only through Original Equipment Manufacturers
                  (OEMs)/Original Component Manufacturers (OCMs) or their
                  franchised dealer or distributors unless pre-approval has been
                  granted by AG Advanced Technologies. Knowingly supplying
                  material deemed or suspected as counterfeit will be considered
                  unethical business practice and would result in a supplier
                  investigation, reporting and possible removal from AG Advanced
              ...
              <div>
                ...
                <p className="mb-3">
                  Identify the issue: Carefully inspect the items and identify
                  any visual discrepancies or inconsistencies that suggest they
                  may be counterfeit.
                </p>
              ...
              <div>
                ...
                <ol className="list-decimal pl-6 space-y-2 text-sm">
                  <li>
                    <strong>Isolate the parts:</strong> Quarantine the suspect
                    counterfeit parts to prevent them from entering the
                    production line or being used in any product.
                  </li>
                  <li>
                    <strong>Document thoroughly:</strong> Create detailed
                    documentation including photos, part numbers, lot numbers,
                    supplier information, and any evidence of the suspected
                    counterfeiting.
                  </li>
                  <li>
                    <strong>Inform your supplier:</strong> Provide evidence and
                    request an explanation. If necessary, require corrective
                    action from the supplier.
                  </li>
                  <li>
                    <strong>Conduct an internal investigation:</strong>{' '}
                    Determine the extent of the problem and potential risks
                    within the supply chain.
                  </li>
                  <li>
                    <strong>Communicate with the customer:</strong> Rework,
                    replace, or repair any fielded product in conjunction with
                    customer input.
                  </li>
                  <li>
                    <strong>
                      Determine if the authorities should be notified
                    </strong>{' '}
                    and which authorities. (FAA, local police, FBI, etc.)
                  </li>
                </ol>
              </div>
              ...
              <div>
                ...
                <ol className="list-decimal pl-6 space-y-2 text-sm">
                  <li>
                    Store counterfeit parts or materials in quarantine, clearly
                    identified as nonconforming/counterfeit product pending a
                    review by your organization's management and legal
                    representation.
                  </li>
                  <li>
                    Do not return Counterfeit to the supplier in such a way that
                    they could be reintroduced into the supply chain to be sold
                    again to another victim.
                  </li>
                  <li>
                    Legal authorities may be contacted to initiate an
                    investigation into the counterfeiting activity. Parts may be
                    required as evidence.
                  </li>
                  <li>
                    Upon conclusion of any investigation, upper management will
                    authorize the disposition and method for disposing of any
              ...
              <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
                ...
                <ul className="space-y-2 text-sm">
                  <li>
                    ➔ Counterfeit materials are a serious threat and can
                    compromise the integrity of the important products we
                    provide.
                  </li>
                  <li>
                    ➔ The use of Original Component or Equipment manufacturers
                    and their authorized sources results in the least risk for
                    counterfeit items infiltrating our products.
                  </li>
                  <li>
                    ➔ If you suspect counterfeit items may have been supplied to
                    AG, you must notify the quality manager immediately.
                  </li>
                  <li>
                    ➔ Counterfeit risk must be controlled throughout the entire
                    supply chain.
                  </li>
                  <li>
            ...
            <CardContent>
              <div className="space-y-6">
                {questions.map((question, index) => (
                  <div key={question.id} className="space-y-3">
                    ...
                    <RadioGroup
                      value={
                        quizAnswers.find((a) => a.questionId === question.id)
                          ?.answer || ''
                      }
                      onValueChange={(value) =>
              ...
              <div className="space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    <Label htmlFor="instructor-signature">
                      Training Instructor
                    </Label>
                    <Input

...
import { Shield, Palette, CheckCircle, Truck, FileText, Users2, Users, Factory, ArrowRightLeft, Wrench } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
        ...
        <Link href="/metal-accessories">
          <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-indigo-200">
            <CardContent className="p-4 text-center">
              <Wrench className="w-8 h-8 text-indigo-600 mx-auto mb-3" />

export const DESIGN_CONTROL_AUTHORIZATION = {
  ...
  configurationView: ['design.configuration.view'],
  configurationEdit: ['design.configuration.edit'],
  configurationApplicabilityApproval: [
    'design.configuration.applicability.approve',
  ],
  configurationRevisionReview: ['design.configuration.revision.review'],
  configurationRevisionRelease: ['design.configuration.revision.release'],
  configurationBaselineCreate: ['design.configuration.baseline.create'],
  configurationReconciliation: ['design.configuration.reconcile'],
  configurationAdministration: ['design.configuration.admin'],

    ...
    <div className="p-8 space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Connect to your Google Drive and import training matrix data from a
            Google Sheet
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <Alert>
            ...
            <AlertDescription>
              Before importing new data, you should delete the existing
              incorrect training matrix data. This will ensure a clean import
              without duplicates.
            </AlertDescription>
          </Alert>
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                {deleteMutation.isPending
                  ? 'Deleting...'
                  : 'Delete Current Training Matrix'}
              </Button>
            </div>
      ...
      <AlertDialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will permanently delete all existing training matrix entries
              from the database. This action cannot be undone. Are you sure you
              want to continue?
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={showImportDialog} onOpenChange={setShowImportDialog}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This will import all training data from the selected Google Sheet
              into the database. Each employee's training completion dates will
              be imported and converted to training matrix entries.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
            <AlertDialogCancel data-testid="button-cancel-import">
              Cancel
            </AlertDialogCancel>
            <AlertDialogAction

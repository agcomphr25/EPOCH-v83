    ...
    <div className="p-6 space-y-6 max-w-full mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 mb-6">
        ...
        <Link href="/barcode-scanner">
          <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-indigo-200">
            <CardContent className="p-4 text-center">
              <ScanBarcode className="w-8 h-8 text-indigo-600 mx-auto mb-3" />
              <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                Barcode Scanner
              </h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
        ...
        <Link href="/admin/order-lookup">
          <Card className="hover:shadow-lg transition-shadow cursor-pointer border-2 hover:border-violet-200">
            <CardContent className="p-4 text-center">
              <Search className="w-8 h-8 text-violet-600 mx-auto mb-3" />
              <h3 className="text-sm font-semibold text-gray-900 dark:text-gray-100">
                Order Lookup
              </h3>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                Search and lookup orders
              </p>
            </CardContent>
          </Card>
        </Link>
      ...
      {dashboardEmployeeId && (
        <MyTasksControlCenter
          ...
          userName={currentUser?.username ?? 'faleeshah'}
          compact={false}
        />
      )}

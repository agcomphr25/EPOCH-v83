...
- **Canonical Material & Source Snapshot**: `production_orders` table includes `material_canonical` (derived from stock model ID prefix) and `source_snapshot` (immutable record of PO state at creation).

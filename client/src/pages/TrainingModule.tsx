    ...
    <div className="bg-white rounded-lg p-8 shadow-sm space-y-8 text-gray-800">
      ...
      <div className="bg-yellow-50 border-l-4 border-yellow-400 p-6 rounded-r-lg">
        ...
        <p className="text-lg leading-relaxed">
          <strong>Foreign Object Debris (FOD)</strong> is any substance alien to
          the part or assembly that could cause damage. This includes any
          material that could be accidentally picked up and included in the
          packaging. It could also be dirt or chemicals that could get in an
          assembly and cause damage or deterioration.
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-6 ml-4">
          <div className="bg-green-50 p-5 rounded-lg border-l-4 border-green-500">
            ...
            <p className="text-lg">
              It is the responsibility of all employees to ensure parts meet
              requirements by:
            </p>
            <ul className="list-disc list-inside ml-4 mt-2 space-y-1 text-lg">
              ...
              <li>
                Rotating stock to use oldest items before they expire (First in,
                First Out - "FIFO")
              </li>
            </ul>
          </div>
          ...
          <div className="bg-purple-50 p-5 rounded-lg border-l-4 border-purple-500">
            ...
            <ul className="list-disc list-inside ml-4 mt-2 space-y-1 text-lg">
              <li>
                Maintain a list of all materials with a shelf life (expiration
                date)
              </li>
          ...
          <div className="bg-orange-50 p-5 rounded-lg border-l-4 border-orange-500">
            ...
            <p className="text-lg">
              It is the responsibility of all employees to see that work areas
              are cleaned and free of any materials not needed to prevent
              damage, deterioration, or loss of traceability.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="bg-blue-50 p-6 rounded-lg space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              <strong>
                Ensure components are not expired or out-of-date before using.
              </strong>
            </p>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              <strong>Any material with a shelf life should be checked.</strong>
            </p>
          </div>
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-8 h-8 bg-blue-600 text-white rounded-full flex items-center justify-center font-bold">
            ...
            <p className="text-lg pt-1">
              <strong>
                Items with a shelf life should have an expiration date listed.
              </strong>
            </p>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              <strong>
                Expired material will be placed in the collection area and
                leaders will submit a waste management form for disposal.
              </strong>
            </p>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              <strong>
                Management will determine disposal of expired items.
              </strong>
            </p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-green-50 p-6 rounded-lg space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              <strong>
                Before starting a job check for any special cleanliness
                requirements.
              </strong>
            </p>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              <strong>
                Clear the work area of any extra material and hardware that
          ...
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              <strong>
                Clean the work area to prevent damage from dirt or chemicals.
              </strong>
            </p>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              <strong>
                Check parts when complete for any unnecessary debris, such as
                poly, shavings, bolts, nuts, etc. and remove any debris.
              </strong>
            </p>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              <strong>
                When finished, package or segregate parts to prevent damage,
                contamination, or loss of traceability.
              </strong>
            </p>
          </div>
        </div>
  ...
  return (
    <div className="bg-white rounded-lg p-8 shadow-sm space-y-8 text-gray-800">
      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
        ...
        <p className="text-lg leading-relaxed">
          To ensure all AG Composites employees work in a{' '}
          <strong>safe environment</strong>. It is paramount that everyone
          follows established procedures to prevent injuries, illnesses, or
          death. If you see another employee not following procedures, correct
          them or immediately notify the department leader or Safety Team.
        </p>
      </div>

      <div className="space-y-4">
        <h3 className="text-2xl font-bold text-purple-900 border-b-2 border-purple-200 pb-2">
        ...
        <div className="bg-purple-50 p-6 rounded-lg space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              ...
              <strong>always refer to the Safety Data Sheet (SDS)</strong> for
              best practices
            </p>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              Know where the{' '}
              <strong>
                Safety Data Sheets (SDS) and Hazard Communication Program
              </strong>{' '}
              can be found
            </p>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              Only two signal words exist: <strong>"Danger"</strong> (more
              severe) and <strong>"Warning"</strong> (less severe)
            </p>
          </div>
          <div className="flex items-start space-x-3">
            <span className="flex-shrink-0 w-8 h-8 bg-purple-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
            ...
            <p className="text-lg pt-1">
              Know what <strong>personal protective equipment (PPE)</strong> is
          ...
          <div className="flex items-start space-x-3">
            ...
            <p className="text-lg pt-1">
              Understand <strong>symptoms of overexposure</strong> and proper
              response procedures
            </p>
          </div>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <h3 className="text-2xl font-bold text-green-900 border-b-2 border-green-200 pb-2">
            Chemical Storage
          </h3>
          ...
          <div className="space-y-3">
            ...
            <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500">
              ...
              <p className="text-base">
                Stored in refrigerated container (65°F - 75°F)
              </p>
            </div>

            <div className="bg-cyan-50 p-4 rounded-lg border-l-4 border-cyan-500">
              <p className="text-lg font-semibold text-cyan-900 mb-1">
                ❄️ Raw Carbon Fiber
              </p>
            ...
            <div className="bg-amber-50 p-4 rounded-lg border-l-4 border-amber-500">
              ...
              <p className="text-base">
                Use First In, First Out based on manufacture date
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-4">
          <h3 className="text-2xl font-bold text-orange-900 border-b-2 border-orange-200 pb-2">
            Chemical Disposal
          </h3>
      ...
      <div className="bg-yellow-50 border-2 border-yellow-400 p-6 rounded-lg">
        ...
        <ol className="list-decimal list-inside space-y-2 text-lg">
          ...
          <li>
            Know general facility safety measures and evacuation procedures
          </li>
  ...
  return (
    <div className="bg-white rounded-lg p-8 shadow-sm space-y-8 text-gray-800">
      <div className="text-center border-b-2 border-red-200 pb-6">
        ...
        <p className="text-lg text-gray-600">
          AG Composites - Composite Manufacturing Environment
        </p>
      </div>
      ...
      <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg">
        ...
        <p className="text-lg leading-relaxed">
          To ensure all AG Composites employees understand{' '}
          <strong>fire safety hazards</strong>,{' '}
          <strong>prevention measures</strong>,
          <strong>emergency response</strong>, and{' '}
          <strong>evacuation procedures</strong>. You will learn to recognize
          risks, respond appropriately, and follow company protocols to maintain
          a safe workplace.
        </p>
      </div>

      <div className="space-y-4">
        <h3 className="text-2xl font-bold text-red-900 border-b-2 border-red-200 pb-2">
          🔥 Fire Hazards in Composite Manufacturing
        </h3>
        ...
        <div className="space-y-4">
          <div className="bg-green-50 p-5 rounded-lg border-l-4 border-green-600">
            ...
            <ul className="list-disc list-inside ml-4 space-y-1 text-base">
              ...
              <li>
                Regularly clean carbon/fiberglass dust with explosion-proof
                vacuums
              </li>
            </ul>
          </div>
          ...
          <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-600">
            ...
            <ul className="list-disc list-inside ml-4 space-y-1 text-base">
              ...
              <li>
                Keep incompatible chemicals separated (oxidizers vs solvents)
              </li>
            </ul>
          </div>
        ...
        <div className="bg-red-50 p-6 rounded-lg space-y-4">
          <div className="flex items-start space-x-3">
            ...
            <div className="pt-1">
              ...
              <p className="text-base">
                Activate nearest fire alarm pull station and dial 911
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div className="pt-1">
              ...
              <p className="text-base">
                Stop work immediately. Follow posted evacuation routes. Move
                quickly and calmly to assembly area
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div className="pt-1">
              ...
              <p className="text-base">
                Small fires may be fought with extinguisher ONLY if trained and
                safe. Never fight large fires
              </p>
            </div>
          </div>
          <div className="flex items-start space-x-3">
            ...
            <div className="pt-1">
              ...
              <p className="text-base">
                Only re-enter after cleared by Fire Department or Safety Officer
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="space-y-3">
            <div>
              ...
              <ul className="list-disc list-inside ml-4 mt-1 text-base">
                <li>
                  <strong>Class A</strong> – wood, paper, trash
                </li>
                <li>
                  <strong>Class B</strong> – flammable liquids (resins,
                  solvents, paints)
                </li>
                <li>
                  <strong>Class C</strong> – electrical equipment
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="bg-green-50 p-6 rounded-lg border-2 border-green-300">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center space-x-3">
              ...
              <p className="text-base">
                <strong>Aim</strong> at the base of the fire
              </p>
            </div>
            <div className="flex items-center space-x-3">
              <span className="flex-shrink-0 w-8 h-8 bg-green-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
              ...
              <p className="text-base">
                <strong>Squeeze</strong> the handle
              </p>
            </div>
            <div className="flex items-center space-x-3">
              <span className="flex-shrink-0 w-8 h-8 bg-green-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
              ...
              <p className="text-base">
                <strong>Sweep</strong> side to side
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-yellow-50 border-2 border-yellow-400 p-6 rounded-lg">
        ...
        <ul className="space-y-2 text-lg">
          <li className="flex items-start gap-2">
            ...
            <span>
              Always know the location of nearest exits and fire extinguishers
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-yellow-600 mt-1">✓</span>
          ...
          <li className="flex items-start gap-2">
            <span className="text-yellow-600 mt-1">✓</span>
            <span>
              Report frayed cords, overheating machines, or chemical leaks
              immediately
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-yellow-600 mt-1">✓</span>
            <span>
              Participate in quarterly fire drills—treat every drill as real
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 font-bold">★</span>
            <span className="font-bold">
              Your safety is the priority—equipment and materials can be
              replaced
            </span>
          </li>
        </ul>
    ...
    <div className="bg-white rounded-lg p-8 shadow-sm space-y-8 text-gray-800">
      ...
      <div className="bg-indigo-50 border-l-4 border-indigo-500 p-6 rounded-r-lg">
        ...
        <p className="text-lg leading-relaxed mb-3">
          Compliance with ITAR is <strong>critical to our business</strong> as a
          U.S. manufacturer of defense-related products and services.
        </p>
        <p className="text-base font-semibold mb-2">
          This training ensures all employees:
        </p>
        <ul className="list-disc list-inside ml-4 space-y-1 text-base">
          <li>Understand their responsibilities under ITAR</li>
          <li>
            Recognize controlled technical data, defense articles, and defense
            services
          </li>
      ...
      <div className="bg-red-50 border-2 border-red-400 p-6 rounded-lg">
        ...
        <p className="text-lg">
          ...
          <strong>severe civil, criminal, and administrative penalties</strong>{' '}
      ...
      <div className="space-y-4">
        ...
        <ul className="space-y-3 ml-4">
          <li className="flex items-start gap-3">
            ...
            <p className="text-lg">
              A set of <strong>U.S. government regulations</strong> administered
          ...
          <li className="flex items-start gap-3">
            <span className="text-indigo-600 mt-1">•</span>
            <p className="text-lg">
              Applies to all U.S. persons and organizations engaged in the
              manufacture, export, or brokering of defense-related items
            </p>
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-500">
            ...
            <p className="text-base">
              Any item or component specifically designed, developed, or
              modified for military use and listed on the USML
            </p>
          </div>
          ...
          <div className="bg-purple-50 p-5 rounded-lg border-l-4 border-purple-500">
            ...
            <p className="text-base">
              Blueprints, drawings, process specifications, test data, and
          ...
          <div className="bg-green-50 p-5 rounded-lg border-l-4 border-green-500">
            ...
            <p className="text-base">
              Assistance, training, or technical support related to defense
              articles
            </p>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base pt-1">
                Protect ITAR-controlled data and materials
              </p>
            </div>
            <div className="flex items-start gap-3">
              <span className="flex-shrink-0 w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
              ...
              <p className="text-base pt-1">
                Verify citizenship status before sharing controlled information
              </p>
            </div>
            <div className="flex items-start gap-3">
              <span className="flex-shrink-0 w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
              ...
              <p className="text-base pt-1">
                Mark and store ITAR documents properly
              </p>
            </div>
            <div className="flex items-start gap-3">
              <span className="flex-shrink-0 w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
              ...
              <p className="text-base pt-1">
                Use company-approved communication systems for ITAR data
              </p>
            </div>
            <div className="flex items-start gap-3">
              <span className="flex-shrink-0 w-8 h-8 bg-indigo-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
              ...
              <p className="text-base pt-1">
                Report potential violations immediately to compliance or
                management
              </p>
            </div>
          </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
          <div className="bg-yellow-50 p-4 rounded-lg border-l-4 border-yellow-500">
            ...
            <p className="text-base">
              All ITAR-controlled documents must be clearly labeled{' '}
              <strong>"ITAR Controlled – Export Controlled"</strong>
            </p>
          </div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-blue-500">
            ...
            <p className="text-base">
              Only U.S. Persons with a business need may access ITAR data
            </p>
          </div>
          ...
          <div className="bg-purple-50 p-4 rounded-lg border-l-4 border-purple-500">
            ...
            <p className="text-base">
              Secure ITAR documents in locked cabinets or restricted-access
              digital systems
            </p>
          </div>
          ...
          <div className="bg-green-50 p-4 rounded-lg border-l-4 border-green-500">
            ...
            <p className="text-base">
              Use encrypted email or secure file transfer only
            </p>
          </div>
          ...
          <div className="bg-red-50 p-4 rounded-lg border-l-4 border-red-500">
            ...
            <p className="text-base">
              Do not discuss ITAR-controlled information in public or with
      ...
      <div className="space-y-4">
        ...
        <div className="bg-red-50 p-6 rounded-lg border-2 border-red-300">
          <p className="text-base font-semibold mb-3">
            You must immediately report if you see:
          </p>
          <ul className="space-y-2 text-base">
            ...
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">⚠️</span>
              <span>
                Technical discussions with unknown vendors or customers
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">⚠️</span>
              <span>
                Foreign nationals working on ITAR projects without clearance
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-gray-500">
        ...
        <ul className="space-y-3 text-base">
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 font-bold">→</span>
            <span>
              An engineer emailed ITAR drawings to a foreign supplier without a
              license → <strong>$20M fine</strong>
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 font-bold">→</span>
            <span>
              A technician allowed a foreign intern on the shop floor with ITAR
              parts visible → <strong>company export license revoked</strong>
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 font-bold">→</span>
            <span>
              A manager discussed controlled technical data with a non-U.S.
              person at a trade show → <strong>DDTC investigation</strong>
            </span>
          </li>
        </ul>
      </div>
      ...
      <div className="bg-indigo-50 border-2 border-indigo-400 p-6 rounded-lg">
        ...
        <p className="text-lg mb-2">
          If you have questions about ITAR compliance or suspect a violation:
        </p>
        <p className="text-base font-semibold">
          Contact the Business Manager or VP of Operations
        </p>
        <p className="text-base">
          Phone: <strong>256-723-8381</strong>
        </p>
        <p className="text-sm mt-3 text-gray-600">
          No retaliation will occur for reporting in good faith.
        </p>
      </div>

      <div className="bg-blue-50 border-2 border-blue-300 p-6 rounded-lg">
        <h3 className="text-xl font-bold text-blue-900 mb-3">
          Who Can Sign ITAR Documents?
        </h3>
        <p className="text-base">
          Only the <strong>VP of Operations</strong> and{' '}
          <strong>Business Manager</strong> are authorized to sign and submit
          ITAR-related documents to the U.S. Department of State.
        </p>
      </div>
    </div>
  );
  ...
  return (
    <div className="bg-white rounded-lg p-8 shadow-sm space-y-8 text-gray-800">
      <div className="text-center border-b-2 border-blue-200 pb-6">
        ...
        <p className="text-lg text-gray-600">
          Quality Management System for Aerospace & Defense
        </p>
      </div>
      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-6 rounded-r-lg">
        ...
        <p className="text-lg leading-relaxed mb-3">
          AS9100 is a <strong>quality management system</strong> for companies
          that design, develop, or provide products for the{' '}
          <strong>aviation, space, and defense industries</strong>.
        </p>
        <p className="text-base font-semibold mb-2">
          AG Composites, LLC dba AG Advanced Technologies ("AG"):
        </p>
        <ul className="list-disc list-inside ml-4 space-y-1 text-base">
          <li>
            Designs, develops, manufactures, and finishes composite components
          </li>
          <li>Assembles composite structures</li>
          <li>Machines metal and composite components</li>
        </ul>
        <p className="text-base mt-3">
          All these processes fall under AG's Quality Management System (QMS).
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-green-50 p-6 rounded-lg border-2 border-green-400">
          <p className="text-xl font-bold text-green-900 text-center leading-relaxed">
            "AG Composites will continuously improve while producing quality
            products in a timely manner to meet customer requirements."
          </p>
          <p className="text-center text-sm text-gray-600 mt-3">
            This is posted on bulletin boards and on the information slide show.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <p className="text-base mb-4">
          Quality objectives are the company's goals. They are also called{' '}
          <strong>Key Performance Indicators (KPIs)</strong> and create a way to
          ...
          <div className="bg-red-50 p-5 rounded-lg border-l-4 border-red-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-base">
                  Goal: <strong>3% or less</strong> for OEM and retail products
                  based on manufacturer defect or error
                </p>
          ...
          <div className="bg-orange-50 p-5 rounded-lg border-l-4 border-orange-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-base">
                  Goal: <strong>1% or less</strong> for nonconforming items
                </p>
                <p className="text-sm text-gray-600">Measured monthly</p>
              </div>
            </div>
          ...
          <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-base">
                  Goal: <strong>90% on-time</strong> shipping
                </p>
                <p className="text-sm text-gray-600">Measured monthly</p>
              </div>
            </div>
          ...
          <div className="bg-green-50 p-5 rounded-lg border-l-4 border-green-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-base">
                  Through training, leader development, audits, reviews, and
                  corrective actions
                </p>
              </div>
            </div>
      ...
      <div className="space-y-4">
        <h3 className="text-2xl font-bold text-indigo-900 border-b-2 border-indigo-200 pb-2">
          Quality Objectives and Your Position
        </h3>

        <p className="text-base mb-3">
          How do the quality objectives relate to your current job?
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          <div className="bg-gray-50 p-4 rounded-lg border">
            ...
            <p className="text-sm">
              Follow processes to prevent returns and defects
            </p>
          </div>
          <div className="bg-gray-50 p-4 rounded-lg border">
            <p className="font-semibold text-gray-800 mb-1">
              2. Scrap/Nonconformities
            </p>
            <p className="text-sm">
              Minimize waste by following procedures correctly
            </p>
          </div>
          <div className="bg-gray-50 p-4 rounded-lg border">
            <p className="font-semibold text-gray-800 mb-1">
            ...
            <p className="text-sm">
              Complete work on time to meet shipping goals
            </p>
          </div>
          <div className="bg-gray-50 p-4 rounded-lg border">
            <p className="font-semibold text-gray-800 mb-1">
          ...
          <div className="bg-gray-50 p-4 rounded-lg border col-span-2">
            ...
            <p className="text-sm">
              Share ideas to improve quality, efficiency, or customer
              satisfaction
            </p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        <h3 className="text-2xl font-bold text-yellow-900 border-b-2 border-yellow-200 pb-2">
          Documents
        </h3>

        <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-500">
          <p className="text-base font-semibold mb-3">
            There will be certain documents and forms required for your
            position.
          </p>
          ...
          <div className="space-y-3">
            <div>
              <p className="font-semibold text-yellow-900 mb-1">
                Where can you find documents for your job?
              </p>
            ...
            <div>
              <p className="font-semibold text-yellow-900 mb-1">
                Where can you find HR documents?
              </p>
              <ul className="list-disc list-inside ml-4 text-sm">
          ...
          <div className="space-y-4">
            <div className="bg-white p-4 rounded border-l-4 border-blue-600">
              <p className="font-semibold text-blue-900 mb-2">
                Follow the processes you were trained to do
              </p>
              <p className="text-sm">
                If you identify a process being changed or done incorrectly,
            ...
            <div className="bg-white p-4 rounded border-l-4 border-blue-600">
              ...
              <p className="text-sm">
                If you identify expired materials, or different materials being
                used, notify a manager immediately
              </p>
            </div>
            ...
            <div className="bg-white p-4 rounded border-l-4 border-blue-600">
              ...
              <p className="text-sm">
                If you have an idea to improve quality, efficiency, or customer
                satisfaction, share it with management or the quality team
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="space-y-4">
        <h3 className="text-2xl font-bold text-red-900 border-b-2 border-red-200 pb-2">
          ⚠️ Negative Actions and Effects
        </h3>
        ...
        <div className="bg-red-50 p-6 rounded-lg border-2 border-red-300">
          <ul className="space-y-3 text-base">
            <li className="flex items-start gap-2">
              ...
              <span>
                <strong>Taking shortcuts</strong> → Creates nonconforming
                products
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>
                <strong>Working in dirty, contaminated space</strong> →
                Introduces foreign objects or debris
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>
                <strong>Speaking rudely to customers</strong> → Upsets
                customers, affects sales
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>
                <strong>Using other employees' tools</strong> → Reduces
                efficiency
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>
                <strong>Not maintaining your tools</strong> → Tools damage
                products, loss of money
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>
                <strong>Forging documents</strong> → Makes materials
                untraceable, alters performance numbers
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>
                <strong>Using expired materials</strong> → Creates nonconforming
                or unsafe products
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>
                <strong>Incorrect storage of chemicals</strong> → Creates unsafe
                environment, potential damage to product
              </span>
            </li>
          </ul>
        </div>
          ...
          <div className="bg-orange-50 p-5 rounded-lg border-l-4 border-orange-500">
            ...
            <ul className="space-y-2 text-base">
              <li className="flex items-start gap-2">
                ...
                <span>
                  Does your work create an unsafe environment or product?
                </span>
              </li>
              ...
              <li className="flex items-start gap-2">
                <span className="text-orange-600">•</span>
                <span>
                  What can you do to keep the product safe for other employees
                  and customers?
                </span>
              </li>
            </ul>
          ...
          <div className="bg-cyan-50 p-5 rounded-lg border-l-4 border-cyan-500">
            ...
            <ul className="space-y-2 text-base">
              ...
              <li className="flex items-start gap-2">
                <span className="text-cyan-600">•</span>
                <span>
                  What can you do to keep the product safe from FOD (Foreign
                  Object Debris)?
                </span>
              </li>
            </ul>
      ...
      <div className="bg-indigo-50 border-2 border-indigo-400 p-6 rounded-lg">
        ...
        <ol className="space-y-2 text-base list-decimal list-inside">
          <li>
            Understand the AS9100 Quality Management System and why AG
            Composites has the certification
          </li>
          <li>Know the quality policy and where it's located</li>
          <li>
            Understand the quality objectives (KPIs) and how they relate to your
            job
          </li>
  ...
  return (
    <div className="bg-white rounded-lg p-8 shadow-sm space-y-8 text-gray-800">
      <div className="text-center border-b-2 border-red-200 pb-6">
        ...
        <p className="text-lg text-gray-600">
          Protecting Product Integrity & Safety
        </p>
      </div>
      ...
      <div className="bg-red-50 border-l-4 border-red-500 p-6 rounded-r-lg">
        ...
        <p className="text-lg leading-relaxed mb-3">
          Counterfeiting is growing in <strong>exponential proportions</strong>{' '}
          with respect to:
        </p>
        <ol className="list-decimal list-inside ml-4 space-y-2 text-base">
          ...
          <li className="font-semibold">
            Potential consequences caused by counterfeits
          </li>
        </ol>
        <p className="text-base mt-4 font-semibold text-red-800">
          If this threat is not adequately addressed, counterfeit items have the
          potential to seriously compromise the safety and operational
      ...
      <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-500">
        ...
        <ul className="space-y-1 text-base">
          <li>
            • <strong>AS9100(D)</strong> Section 8.1.4
          </li>
          <li>
            • <strong>Quality Manual</strong> Section 8.1.4
          </li>
          <li>
            • <strong>Process Manual</strong> Section 3.13
          </li>
        </ul>
      </div>
        ...
        <div className="grid gap-4">
          <div className="bg-purple-50 p-5 rounded-lg border-l-4 border-purple-500">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base pt-1">
                The <strong>risks and impacts</strong> of counterfeit parts
          ...
          <div className="bg-purple-50 p-5 rounded-lg border-l-4 border-purple-500">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base pt-1">
                <strong>Best practices</strong> to eliminate or mitigate those
                risks
              </p>
            </div>
          </div>
          ...
          <div className="bg-purple-50 p-5 rounded-lg border-l-4 border-purple-500">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base pt-1">
                The{' '}
                <strong>
                  AG Composites counterfeit prevention requirements
                </strong>{' '}
                for suppliers
              </p>
            </div>
        ...
        <div className="bg-red-50 p-6 rounded-lg border-2 border-red-300">
          ...
          <ul className="space-y-3 text-base">
            ...
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1 text-xl">⚠</span>
              <span>
                <strong>Reduced reliability and product recall</strong>
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1 text-xl">⚠</span>
              <span>
                <strong>Potential loss of contracts</strong>
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1 text-xl">⚠</span>
              <span>
                <strong>Shutdown of manufacturing lines</strong>
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1 text-xl">⚠</span>
              <span>
                <strong>Negative cost and schedule impacts</strong>
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1 text-xl">⚠</span>
              <span>
                <strong>Penalties for companies and individuals</strong>
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1 text-xl">⚠</span>
              <span>
                <strong>Damage to our image</strong>
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-start gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-lg mt-1">
                  Procuring directly from the{' '}
                  <strong>
                    Original Component or Equipment Manufacturer (OCM/OEM)
                  </strong>
                </p>
              </div>
            </div>
          ...
          <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
            <div className="flex items-start gap-3 mb-3">
              ...
              <div>
                ...
                <p className="text-lg mt-1">
                  <strong>OCM Authorized Distributors</strong>
                </p>
              </div>
            </div>
            <ul className="ml-12 space-y-2 text-base">
              <li>
                • OCM Authorized distributors have{' '}
                <strong>documented sales agreements</strong> with manufacturers
              </li>
              <li>
                • Inventory manager should{' '}
                <strong>verify authorized distributor status</strong> with the
                manufacturer
              </li>
            </ul>
          </div>
          ...
          <div className="bg-blue-50 p-5 rounded-lg border-l-4 border-blue-500">
            <p className="text-base font-semibold">
              <strong>AG Purchase Orders</strong> require suppliers to use OCMs
              or their authorized sources for products that will be delivered to
              Lockheed Martin.
            </p>
          </div>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border-2 border-indigo-400">
          ...
          <div className="text-base space-y-3 leading-relaxed">
            <p>
              Suppliers shall ensure through their{' '}
              <strong>processes and/or a formal program</strong> against the
              receipt of counterfeit materials into their inventory, against
              their use in manufacturing, and against their being sold to other
              suppliers.
            </p>
            <p>
              Supplier shall{' '}
              <strong className="text-red-700">
                NOT deliver counterfeit work or suspect counterfeit work
              </strong>{' '}
              to AG Advanced Technologies.
            </p>
            <p>
              All parts and materials shall be procured{' '}
              <strong>
                only through Original Equipment Manufacturers (OEMs)/Original
                Component Manufacturers (OCMs) or their franchised dealer or
                distributors
              </strong>{' '}
              unless pre-approval has been granted by AG Advanced Technologies.
            </p>
            <p className="text-red-800 font-semibold">
              Knowingly supplying material deemed or suspected as counterfeit
              will be considered <strong>unethical business practice</strong>{' '}
              and would result in a supplier investigation, reporting and
              possible{' '}
              <strong>
                removal from AG Advanced Technologies Approved Supplier list
              </strong>
              .
            </p>
          </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-orange-50 p-6 rounded-lg border-l-4 border-orange-500">
          <p className="text-lg font-semibold text-orange-900 mb-4">
            Identify the issue: Carefully inspect the items and identify any
            visual discrepancies or inconsistencies that suggest they may be
            counterfeit.
          </p>
          ...
          <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm">
                  Quarantine the suspect counterfeit parts to prevent them from
                  entering the production line or being used in any product
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm">
                  Create detailed documentation including photos, part numbers,
                  lot numbers, supplier information, and any evidence of the
          ...
          <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm">
                  Provide evidence and request an explanation. If necessary,
                  require corrective action from the supplier
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm">
                  Determine the extent of the problem and potential risks within
                  the supply chain
                </p>
              </div>
            </div>
          ...
          <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm">
                  Rework, replace, or repair any fielded product in conjunction
                  with customer input
                </p>
              </div>
            </div>
          ...
          <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-500">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm">
                  Consider notifying FAA, local police, FBI, etc.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-3">
          <div className="bg-gray-50 p-5 rounded-lg border-l-4 border-gray-500">
            <div className="flex items-start gap-3">
              <span className="flex-shrink-0 w-8 h-8 bg-gray-600 text-white rounded-full flex items-center justify-center font-bold text-sm">
                1
              </span>
              <p className="text-base pt-1">
                Store counterfeit parts or materials in{' '}
                <strong>quarantine</strong>, clearly identified as
                nonconforming/counterfeit product pending a review by your
                organization's management and legal representation
              </p>
            </div>
          </div>
          ...
          <div className="bg-red-100 p-5 rounded-lg border-2 border-red-500">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base pt-1 font-semibold text-red-900">
                Do <strong className="underline">NOT</strong> return Counterfeit
                to the supplier in such a way that they could be reintroduced
                into the supply chain to be sold again to another victim
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-5 rounded-lg border-l-4 border-gray-500">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base pt-1">
                Legal authorities may be contacted to initiate an investigation
                into the counterfeiting activity. Parts may be required as
                evidence
              </p>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-5 rounded-lg border-l-4 border-gray-500">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base pt-1">
                Upon conclusion of any investigation,{' '}
                <strong>upper management will authorize the disposition</strong>{' '}
                and method for disposing of any suspect/counterfeit items
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-green-50 border-2 border-blue-300 p-6 rounded-lg">
        ...
        <ul className="space-y-3 text-base">
          <li className="flex items-start gap-2">
            ...
            <span>
              Counterfeit materials are a <strong>serious threat</strong> and
              can compromise the integrity of the important products we provide
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-blue-600 mt-1">✓</span>
            <span>
              The use of{' '}
              <strong>
                Original Component or Equipment manufacturers and their
                authorized sources
              </strong>{' '}
              results in the least risk for counterfeit items infiltrating our
              products
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 font-bold">!</span>
            <span>
              If you suspect counterfeit items may have been supplied to AG, you
              must{' '}
              <strong className="text-red-700">
                notify the Quality Manager immediately
              </strong>
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-blue-600 mt-1">✓</span>
            <span>
              Counterfeit risk must be controlled{' '}
              <strong>throughout the entire supply chain</strong>
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-blue-600 mt-1">✓</span>
            <span>
              Thank you for your continued efforts to ensure counterfeit
              components do not infiltrate our supply chains
            </span>
          </li>
        </ul>
      </div>
  ...
  return (
    <div className="bg-white rounded-lg p-8 shadow-sm space-y-8 text-gray-800">
      <div className="text-center border-b-2 border-blue-200 pb-6">
        ...
        <p className="text-lg text-gray-600">
          Integrity, Honesty, and Transparency in Manufacturing
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
          <h4 className="text-lg font-bold text-blue-900 mb-3">
            Definition of Ethical Behavior in Aerospace
          </h4>
          <ul className="space-y-2 text-base ml-4">
            <li>
              •{' '}
              <strong>Acting with honesty, integrity, and transparency</strong>
            </li>
            <li>
              • <strong>Commitment to safety and compliance</strong>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border-l-4 border-indigo-500">
          <h4 className="text-lg font-bold text-indigo-900 mb-3">
            Why Ethics Matter in Aerospace
          </h4>
          <ul className="space-y-2 text-base ml-4">
            <li>
              •{' '}
              <strong>
                Direct impact on flight safety and end-user protection
              </strong>
            </li>
            <li>
              • <strong>Legal and regulatory consequences</strong> for unethical
              actions
            </li>
          </ul>
        </div>
        ...
        <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
          <h4 className="text-lg font-bold text-purple-900 mb-3">
            Connection to AS9100 Requirements
          </h4>
          <ul className="space-y-2 text-base ml-4">
            <li>
              • <strong>Clause 7.3:</strong> Awareness of ethical behavior
            </li>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-red-50 p-6 rounded-lg border-2 border-red-400">
          <h4 className="text-xl font-bold text-red-900 mb-4">
            Definition and Types of Falsification
          </h4>
          <ul className="space-y-3 text-base">
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>
                <strong>Altering inspection or test results</strong>
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>
                <strong>Creating fraudulent documentation</strong> (e.g., fake
                certificates)
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="text-red-600 mt-1">✗</span>
              <span>
                <strong>Backdating or pre-dating signatures</strong>
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-orange-50 p-6 rounded-lg border-l-4 border-orange-500">
          <h4 className="text-lg font-bold text-orange-900 mb-3">
            Common Causes of Falsification
          </h4>
          <ul className="space-y-2 text-base ml-4">
        ...
        <div className="bg-gray-100 p-6 rounded-lg border-2 border-gray-400">
          <h4 className="text-xl font-bold text-gray-900 mb-4">
            ⚠️ Consequences for Individuals and Organizations
          </h4>
          <div className="grid md:grid-cols-2 gap-4">
            <div>
        ...
        <div className="space-y-4">
          <div className="bg-white p-5 rounded-lg">
            ...
            <p className="text-base leading-relaxed">
              In 2020, a major Boeing supplier,{' '}
              <strong>Spirit AeroSystems</strong>, was found to have{' '}
              <strong className="text-red-700">
                falsified inspection records
              </strong>{' '}
              related to structural components for Boeing aircraft, including
              the <strong>737 MAX and 787 Dreamliner</strong>. The falsification
              included documentation that certain parts passed quality
              inspections{' '}
              <strong className="text-red-700">
                when they had not been properly inspected
              </strong>
              .
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-lg">
            ...
            <ul className="space-y-2 text-base ml-4">
              <li>
                • Employees signed off on inspection reports{' '}
                <strong className="text-red-700">
                  without actually performing the required checks
                </strong>
              </li>
              <li>
                • This included <strong>critical structural elements</strong>{' '}
                (fuselage sections, bulkhead assemblies)
              </li>
              <li>
                • Initially driven by{' '}
                <strong>pressure to meet production schedules</strong> and avoid
                delays
              </li>
              <li>
                • When uncovered, investigation revealed it had occurred{' '}
                <strong>over several years</strong>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-white p-5 rounded-lg">
            ...
            <ul className="space-y-2 text-base ml-4">
              <li>
                ...
                and perform extensive inspections and rework
              </li>
              <li>
                • The supplier faced significant{' '}
                <strong>financial penalties</strong> and loss of customer trust
              </li>
              <li>
                • Multiple employees were <strong>terminated</strong>, some
                faced <strong>legal consequences</strong>
              </li>
              <li>
                • FAA <strong>increased oversight</strong> of both Boeing and
                its suppliers
              </li>
              <li>
                • The incident <strong>damaged Boeing's reputation</strong>
              </li>
            </ul>
          </div>
          ...
          <div className="bg-green-50 p-5 rounded-lg border-2 border-green-500">
            ...
            <ul className="space-y-2 text-base ml-4">
              <li>
                •{' '}
                <strong>
                  Production speed must never override safety and compliance
                </strong>
              </li>
              <li>
                • Falsification{' '}
                <strong>endangers jobs and entire companies</strong>
              </li>
              <li>
                • Companies must foster a culture where employees{' '}
                <strong>feel safe to report problems</strong>
              </li>
              <li>
                • <strong>Regular audits and independent verification</strong>{' '}
                are critical
              </li>
            </ul>
          </div>
      ...
      <div className="space-y-4">
        <h3 className="text-2xl font-bold text-yellow-900 border-b-2 border-yellow-200 pb-2">
          3. Handling Non-Conforming Material
        </h3>

        <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-yellow-500">
          <h4 className="text-lg font-bold text-yellow-900 mb-3">
            Definition of Non-Conforming Material
          </h4>
          <p className="text-base mb-2">
            <strong>
              Parts or processes that do not meet specification requirements
            </strong>
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold">
                  Immediate identification and tagging
                </p>
                <p className="text-sm">
                  Tag defective parts immediately upon discovery
                </p>
              </div>
            </div>
            <div className="flex items-start gap-3">
        ...
        <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
          ...
          <ul className="space-y-2 text-base ml-4">
            <li>
              • <strong>Who to notify:</strong> Supervisor, quality department
            </li>
            <li>
              • <strong>Documentation required:</strong> Non-conformance report
            </li>
            <li>
              • <strong>Timeliness and accuracy</strong> in reporting
            </li>
          </ul>
        </div>
      ...
      <div className="space-y-4">
        <h3 className="text-2xl font-bold text-orange-900 border-b-2 border-orange-200 pb-2">
          4. Prevention of Counterfeit Parts
        </h3>
        ...
        <div className="bg-orange-50 p-6 rounded-lg border-2 border-orange-400">
          ...
          <ul className="space-y-2 text-base ml-4">
            <li>
              • Any <strong>unauthorized copy, imitation, or substitute</strong>
            </li>
            <li>
              • Parts{' '}
              <strong>
                misrepresented in origin, composition, or certification
              </strong>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-red-50 p-6 rounded-lg border-2 border-red-400">
          <h4 className="text-lg font-bold text-red-900 mb-3">
            ⚠️ Risks Associated with Counterfeit Parts
          </h4>
          <ul className="space-y-2 text-base ml-4">
            <li>
              • <strong>Safety hazards</strong> leading to equipment failure
            </li>
            <li>
              • <strong>Legal and contractual consequences</strong>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border-l-4 border-indigo-500">
          ...
          <ul className="space-y-2 text-base ml-4">
            <li>
              • <strong>Approved supplier lists</strong> and audits
            </li>
            <li>
              • <strong>Receiving inspection processes</strong>
            </li>
            <li>
              • <strong>Supplier ethical behavior training</strong> requirements
            </li>
          </ul>
        </div>
        ...
        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
          ...
          <ul className="space-y-2 text-base ml-4">
            <li>
              • <strong>Traceability</strong> of materials and components
            </li>
            <li>
              •{' '}
              <strong>Verification of Certificates of Conformity (CoC)</strong>
            </li>
            <li>
              • Use of <strong>barcodes or QR codes</strong> for tracking
            </li>
            <li>
              • <strong>Mandatory reporting</strong> of suspected counterfeit
              parts to customers and authorities
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <h3 className="text-2xl font-bold text-cyan-900 border-b-2 border-cyan-200 pb-2">
          5. Responsibilities of Employees and Suppliers
        </h3>
        ...
        <div className="bg-green-50 p-5 rounded-lg border-l-4 border-green-500">
          <h4 className="text-lg font-bold text-green-900 mb-2">
            🤝 Joint Responsibility in the Supply Chain
          </h4>
          <ul className="space-y-2 text-base ml-4">
            <li>
              • <strong>Shared accountability</strong> for quality and
              compliance
            </li>
            <li>
              • <strong>Collaborative efforts</strong> to prevent defects and
              unethical practices
            </li>
          </ul>
        </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-indigo-50 p-6 rounded-lg border-2 border-indigo-400">
          <h4 className="text-xl font-bold text-indigo-900 mb-4">
            Purpose of a Whistleblower Policy
          </h4>
          <ul className="space-y-2 text-base ml-4">
            <li>
              • <strong>Protect individuals</strong> who report issues in good
              faith
            </li>
            <li>
              • <strong>Encourage early identification</strong> of problems
            </li>
          </ul>
        </div>
        ...
        <div className="bg-red-50 p-6 rounded-lg border-2 border-red-400">
          ...
          <ul className="space-y-2 text-base ml-4">
            <li>
              • <strong>Falsification of records</strong>
            </li>
            <li>
              • <strong>Safety hazards</strong> or unsafe work practices
            </li>
            <li>
              • <strong>Theft, fraud, or financial misconduct</strong>
            </li>
            <li>
              • <strong>Retaliation or harassment</strong> against those who
              report
            </li>
          </ul>
        </div>
        ...
        <div className="bg-blue-50 p-6 rounded-lg border-l-4 border-blue-500">
          ...
          <ul className="space-y-2 text-base ml-4">
            <li>
              • <strong>Internal reporting:</strong> Supervisor, HR, quality
              manager
            </li>
            <li>
              • <strong>Anonymous reporting:</strong> Hotlines or digital forms
            </li>
            <li>
              • <strong>External reporting:</strong> Regulatory bodies (FAA,
              ISO, etc.)
            </li>
          </ul>
        </div>
        ...
        <div className="bg-green-50 p-6 rounded-lg border-2 border-green-400">
          ...
          <ul className="space-y-2 text-base ml-4">
            <li>
              • <strong>No retaliation policy</strong>
            </li>
            <li>
              • <strong>Confidential handling</strong> of complaints
            </li>
            <li>
              • <strong>Legal protections</strong> under federal and state laws
            </li>
          </ul>
        </div>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-400 p-8 rounded-lg">
        ...
        <ul className="space-y-3 text-base">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>Ethical behavior is everyone's responsibility</strong> and
          ...
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 text-xl">!</span>
            <span>
              <strong>Falsification of records has severe consequences</strong>{' '}
          ...
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>
                Non-conforming material must be identified, quarantined, and
                documented
              </strong>{' '}
              immediately
            </span>
          ...
          <li className="flex items-start gap-2">
            <span className="text-blue-600 mt-1 text-xl">✓</span>
            <span>
              <strong>Counterfeit prevention requires vigilance</strong>{' '}
          ...
          <li className="flex items-start gap-2">
            <span className="text-blue-600 mt-1 text-xl">✓</span>
            <span>
              <strong>Report issues immediately</strong> - Whistleblower
              policies protect those who speak up
            </span>
          </li>
          <li className="flex items-start gap-2">
  ...
  return (
    <div className="bg-white rounded-lg p-8 shadow-sm space-y-8 text-gray-800">
      <div className="text-center border-b-2 border-orange-200 pb-6">
        ...
        <p className="text-lg text-gray-600">
          Managing Quality Issues Throughout Production
        </p>
      </div>

      <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-500">
        <h3 className="text-xl font-bold text-red-900 mb-3">
          Definition: Nonconforming Items
        </h3>
        <p className="text-lg leading-relaxed mb-3">
          <strong>Nonconforming items</strong> are products or materials that{' '}
          <strong className="text-red-700">
            don't meet the requirements or standards
          </strong>{' '}
          for their intended use.
        </p>
        <div className="bg-white p-4 rounded-lg mt-4">
          <p className="font-semibold text-gray-800 mb-2">
            Non-conformances can occur at any stage:
          </p>
      ...
      <div className="bg-blue-50 p-6 rounded-lg border-2 border-blue-400">
        <h3 className="text-2xl font-bold text-blue-900 mb-4">
          Three Categories of Nonconforming Items
        </h3>
        <div className="grid md:grid-cols-3 gap-4">
        ...
        <div className="space-y-3">
          <div className="bg-red-50 p-5 rounded-lg border-l-4 border-red-500">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base pt-1">
                Scrap items are normally created from{' '}
                <strong>
                  neglect, environmental changes, or supply changes
                </strong>
              </p>
            </div>
          </div>
          ...
          <div className="bg-red-50 p-5 rounded-lg border-l-4 border-red-500">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base pt-1">
                Scrap items are collected in{' '}
                <strong className="text-red-700">red barrels</strong> at the{' '}
                <strong>line manager's work area</strong>
              </p>
            </div>
          </div>
          ...
          <div className="bg-red-50 p-5 rounded-lg border-l-4 border-red-500">
            <div className="flex items-start gap-3">
              ...
              <div className="pt-1">
                <p className="text-base mb-2">
                  Scrap items will be{' '}
                  <strong className="text-red-700">red tagged</strong> and
                  uploaded into the{' '}
                  <strong>Nonconforming Items spreadsheet</strong> by the
        ...
        <div className="space-y-3">
          <div className="bg-yellow-50 p-5 rounded-lg border-l-4 border-yellow-500">
            <div className="flex items-start gap-3">
              ...
              <p className="text-base pt-1">
                Returns from customers will be{' '}
                <strong className="text-yellow-700">
                  red tagged by the sales team
                </strong>
              </p>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="pt-1 w-full">
                ...
                <p className="text-sm mb-3">
                  <strong>Authorization:</strong> Business Manager, Production
                  Manager, or Upper Management
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white p-4 rounded-lg border-l-4 border-green-500">
                    ...
                    <p className="text-sm">
                      Repair or change the item for return to the customer
                    </p>
                  </div>
                  ...
                  <div className="bg-white p-4 rounded-lg border-l-4 border-blue-500">
                    ...
                    <p className="text-sm">
                      Items that do not meet initial customer requirements but
                      the variation is <strong>approved by the customer</strong>
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="space-y-3">
          <div className="bg-orange-50 p-5 rounded-lg border-l-4 border-orange-500">
            <div className="flex items-start gap-3">
              ...
              <div className="pt-1">
                ...
                <p className="text-base">
                  Counterfeit items are items that{' '}
                  <strong className="text-orange-700">
                    introduced to the supply chain and/or production line
                  </strong>{' '}
                  that are <strong>fake or unauthorized replicas</strong> of
          ...
          <div className="bg-red-100 p-5 rounded-lg border-2 border-red-500">
            <div className="flex items-start gap-3">
              ...
              <div className="pt-1">
                ...
                <p className="text-base">
                  Items that are suspected to be counterfeit are{' '}
                  <strong className="text-red-700">
                    immediately isolated in the business office
                  </strong>
                </p>
              </div>
            </div>
          ...
          <div className="bg-indigo-50 p-5 rounded-lg border-l-4 border-indigo-500">
            <div className="flex items-start gap-3">
              ...
              <div className="pt-1">
                <p className="text-base mb-2">
                  <strong>Investigation & Disposition:</strong>
                </p>
                <ul className="space-y-2 text-base ml-4">
                  <li>
                    • <strong>Trained personnel</strong> will be assigned to
                    investigate the potential counterfeit items
                  </li>
                  <li>
                    • Eventual disposition will be determined by{' '}
      ...
      <div className="bg-gradient-to-r from-orange-50 to-red-50 border-2 border-orange-400 p-8 rounded-lg">
        ...
        <ul className="space-y-3 text-base">
          <li className="flex items-start gap-2">
            ...
            <span>
              <strong>Three Categories:</strong> All nonconforming items fall
              into Scrap, Returns, or Counterfeit
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 text-xl font-bold">2</span>
            <span>
              <strong>Red Tagging:</strong> Scrap (by line manager) and Returns
              (by sales team) must be red tagged
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 text-xl font-bold">3</span>
            <span>
              <strong>Documentation:</strong> All items must be logged in the
              Nonconforming Items spreadsheet
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 text-xl font-bold">4</span>
            <span>
              <strong>Scrap = Destroy:</strong> Scrap items have only ONE
              disposition - render unusable and dispose
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-orange-600 mt-1 text-xl font-bold">5</span>
            <span>
              <strong>Returns have 3 options:</strong> Scrap, Repair, or Use
              As-Is (with customer approval)
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-red-600 mt-1 text-xl font-bold">!</span>
            <span>
              <strong>Counterfeit = Immediate Isolation:</strong> Suspected
              counterfeit items must be immediately isolated in the business
              office
            </span>
          </li>
          <li className="flex items-start gap-2">
            <span className="text-blue-600 mt-1 text-xl">✓</span>
            <span>
              <strong>Authorization matters:</strong> Know who can authorize
          ...
          <li className="flex items-start gap-2">
            <span className="text-green-600 mt-1 text-xl">✓</span>
            <span>
              <strong>Any stage:</strong> Non-conformances can occur from design
              through delivery
            </span>
          </li>
        </ul>
  ...
  return (
    <div className="bg-white rounded-lg p-8 shadow-sm space-y-8 text-gray-800">
      <div className="text-center border-b-2 border-indigo-200 pb-6">
        ...
        <p className="text-lg text-gray-600">
          Daily Facility Closing & Security Protocols
        </p>
        <p className="text-sm text-gray-500 mt-2">
          Processes and tasks required to correctly lock up the facility each
          day
        </p>
      </div>
          ...
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <span className="text-base">
                Remove all tools from the machine spindles
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-blue-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Turn machines to the <strong>OFF home position</strong>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-blue-600 mt-0.5 flex-shrink-0" />
        ...
        <div className="bg-green-50 p-6 rounded-lg border-l-4 border-green-500">
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Place all tools and drills in the{' '}
                <strong>correct toolbox</strong>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Close and latch the roll down door
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Close and lock the pedestrian exit door
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
        ...
        <div className="bg-purple-50 p-6 rounded-lg border-l-4 border-purple-500">
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Close the door to the mixing shed
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                <strong>Ensure the oven timers are set to turn OFF</strong>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Close and latch both roll down doors in the oven area
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
        ...
        <div className="bg-orange-50 p-6 rounded-lg border-l-4 border-orange-500">
          <ul className="space-y-3">
            <li className="flex items-start gap-3">
              ...
              <span className="text-base">
                <strong>Clean and break down paint guns</strong>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-orange-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Turn OFF paint booth fan and lights
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-orange-600 mt-0.5 flex-shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-orange-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Close all cabinets and the paint closet
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-gray-50 p-6 rounded-lg border-l-4 border-gray-500">
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-gray-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Verify all air compressors are OFF
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-gray-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Close and lock all container doors
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-gray-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Close and latch the roll down doors
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-gray-600 mt-0.5 flex-shrink-0" />
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-gray-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                <strong>Ensure the security gate closes</strong>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-gray-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Check the front office - if you are the last person to leave,{' '}
                <strong>set the alarm and lock the front door</strong>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-gray-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Walk through the sanding shed turn off lights and remove tools
              </span>
            </li>
          </ul>
        </div>
        ...
        <div className="bg-cyan-50 p-6 rounded-lg border-l-4 border-cyan-500">
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-cyan-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Ensure bathroom and office lights are OFF
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-cyan-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                <strong>Ensure hall and porch lights are ON</strong>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-cyan-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                Check the back building - if you are the last person to leave,{' '}
                <strong>set the alarm and lock the front door</strong>
              </span>
            </li>
            <li className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-cyan-600 mt-0.5 flex-shrink-0" />
              <span className="text-base">
                <strong>Ensure the security gate is closed</strong>
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="bg-gradient-to-r from-indigo-50 to-blue-50 border-2 border-indigo-400 p-8 rounded-lg">
        ...
        <div className="mt-4 bg-yellow-100 border-l-4 border-yellow-500 p-4 rounded">
          <p className="text-base font-semibold text-yellow-900">
            💡 Final Walk Through: Turn off lights in CNC area and verify all
...
export default function TrainingModule() {
  ...
  const handleSubmit = () => {
    ...
    if (
      ...
      Object.keys(answers).length < moduleData.questions.length
    ) {
      toast({
          ...
          <CardContent className="space-y-4">
            ...
            {results.passed ? (
              <div className="space-y-4">
                <Alert className="bg-green-50 border-green-200">
                  ...
                  <AlertDescription className="text-green-800">
                    You have successfully completed this training module and
                    earned your certification! Your certificate has been issued
                    and recorded in your employee profile.
                  </AlertDescription>
                </Alert>
              ...
              <Alert variant="destructive">
                ...
                <AlertDescription>
                  You need at least {results.passingScore}% to pass. Please

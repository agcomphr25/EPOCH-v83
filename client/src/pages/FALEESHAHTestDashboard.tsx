...
import { Shield, Palette, CheckCircle, Truck, FileText, Users2, Users, Factory, LogOut } from 'lucide-react';
  ...
  return (
    <div className="p-6 space-y-6 max-w-full mx-auto">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Welcome, FALEESHAH</h1>

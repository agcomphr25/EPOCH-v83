    ...
    if (!dbConnected) {
      ...
      try {
        const epochCapabilities = [
          ...
          { key: 'manufacturing.stock_build.view', description: 'View P1/P2 stock-build requests and readiness', category: 'inventory' },
          { key: 'manufacturing.stock_build.create', description: 'Create controlled P1/P2 stock-build drafts', category: 'inventory' },
          { key: 'manufacturing.stock_build.release', description: 'Release controlled P1/P2 stock-build requests', category: 'inventory' },

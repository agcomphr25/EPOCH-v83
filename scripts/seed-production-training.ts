      ...
      .values([
        {
          ...
          description:
            'Comprehensive training on preservation techniques and FOD prevention to ensure product quality and prevent contamination.',
        ...
        },
        {
          ...
          description:
            'Essential training on safe chemical handling, proper storage procedures, and disposal requirements.',
          pdfUrl:
            '/attached_assets/Employee Chemical Handling Training_1759351845055.pdf',
          passingScore: 80,
          isActive: true,
        },
        {
          ...
          description:
            'Critical fire safety procedures, emergency response, and prevention strategies.',
        ...
        },
        {
          ...
          description:
            'International Traffic in Arms Regulations (ITAR) compliance and export control requirements.',
          pdfUrl:
            '/attached_assets/Annual ITAR Training.docx - Google Docs_1759352442796.pdf',
          passingScore: 80,
          isActive: true,
        },
        {
          ...
          description:
            'Introduction to AS9100 quality management system requirements for aerospace manufacturing.',
        ...
        },
        {
          ...
          description:
            'Training on identifying and preventing counterfeit materials in aerospace supply chain.',
          pdfUrl:
            '/attached_assets/Counterfeit Prevention Training_1759353475520.pdf',
          passingScore: 80,
          isActive: true,
        },
        {
          ...
          description:
            'Ethical standards and responsibilities in aerospace quality management.',
        ...
        },
        {
          ...
          description:
            'Leadership training on managing and addressing nonconforming items in production.',
          pdfUrl:
            '/attached_assets/Nonconforming Items - Google Docs_1759353680422.pdf',
          passingScore: 80,
          isActive: true,
        },
        {
          ...
          description:
            'Leadership training on proper facility shut down procedures and safety protocols.',
          pdfUrl:
            '/attached_assets/AG Shutdown Procedures - Google Docs_1759353753638.pdf',
          passingScore: 80,
          isActive: true,
        },
      ])

...
export function OrderIDGenerator() {
  ...
  const runP1Tests = () => {
    const tests = [
      // Same month tests
      {
        test: 'Same month increment',
        date: '2025-07-15',
        lastId: 'EG005',
        expected: 'EG006',
      },
      {
        test: 'Same month from 999 to 1000',
        date: '2025-07-15',
        lastId: 'EG999',
        expected: 'EG1000',
      },
      {
        test: 'Same month high number',
        date: '2025-07-15',
        lastId: 'EG1500',
        expected: 'EG1501',
      },
      ...
      {
        test: 'Invalid lastId format',
        date: '2025-07-15',
        lastId: 'INVALID',
        expected: 'EG001',
      },
      {
        test: 'Old format lastId',
        date: '2025-07-15',
        lastId: 'AP001',
        expected: 'EG001',
      },

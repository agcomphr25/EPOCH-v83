...
const persistentDiscountFormSchema = insertPersistentDiscountSchema
  .extend({
  ...
  .refine(
    ...
    {
      message:
        'Either percent or fixed amount is required for non-custom discounts',
      path: ['percent'],
    }
  );
                      ...
                      <FormItem>
                        ...
                        {createForm.watch('name') === 'Custom' && (
                          <div className="text-sm text-muted-foreground">
                            Custom discounts allow ad-hoc percentage or amount
                            during order entry
                          </div>
                        )}
                      </FormItem>

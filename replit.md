...
- **Key Features**:
    ...
    - **Training Management System**: Comprehensive training platform with PDF import using Azure Document Intelligence for automatic content extraction, module creation with quizzes and evaluations, employee training records tracking, certification management, legacy training matrix import, and automatic certificate generation. Supports MULTIPLE_CHOICE, TRUE_FALSE, and SHORT_ANSWER question types with detailed attempt tracking and scoring.

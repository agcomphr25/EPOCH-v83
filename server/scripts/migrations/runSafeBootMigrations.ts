...
export const safeMigrationFiles = [
  ...
  '0293_inventory_foam_and_3d_cutting_categories.sql',
  ...
  '0317_product_teardown_observation_capture.sql',
  ...
  '0325_canonical_manufacturing_queue_departments.sql',
  '0325_employee_machine_qualifications.sql',
  '0326_finance_operations_stage0_retention.sql',

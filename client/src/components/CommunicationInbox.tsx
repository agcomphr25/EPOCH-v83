...
export default function CommunicationInbox() {
  ...
  const sendCompose = async () => {
    ...
    setSending(true);
    try {
      const endpoint = composeData.method === 'email' 
        ? '/api/communications/email' 
        : '/api/communications/sms';
      ...
      await apiRequest(endpoint, {
        ...
        body: {
          ...
          subject: composeData.method === 'email' ? composeData.subject : undefined,
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={fetchMessages} variant="outline" data-testid="button-refresh">
            Refresh
          </Button>
        </div>
      </div>
        ...
        <DialogContent className="max-w-2xl">
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={(e) => setComposeData({ ...composeData, method: e.target.value as 'email' | 'sms' })}
              ...
              <div>
                <label className="text-sm font-medium mb-2 block">
                  {composeData.method === 'email' ? 'Email Address' : 'Phone Number'}
                </label>
                <Input
                  placeholder={composeData.method === 'email' ? 'customer@example.com' : '+1234567890'}
            ...
            <div className="flex justify-end space-x-2">
              ...
              <Button 
                onClick={sendCompose}
                disabled={sending || !composeData.recipient.trim() || !composeData.message.trim()}

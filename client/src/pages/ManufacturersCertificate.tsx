...
export default function ManufacturersCertificate() {
  ...
  const [formData, setFormData] = useState({
    ...
    certificationText:
      CERTIFICATE_TEMPLATES.manufacturersConformance.certificationText,
        ...
        setFormData((prev) => ({
          ...{
            ...
            certificationText:
              CERTIFICATE_TEMPLATES.manufacturersConformance.certificationText,
            otherDataText:
              CERTIFICATE_TEMPLATES.manufacturersConformance.otherDataText,
            signatureDataURL: '',
            signatureDate: '',
            signerTitle: '',
            status: 'DRAFT',
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <Label htmlFor="lotNumber" className="text-sm font-semibold">
                  Lot Number *
                </Label>
                <Input
                  id="lotNumber"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange('drawingNumber', e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                <Label
                  htmlFor="sourceManufacturer"
                  className="text-sm font-semibold"
                >
                  SOURCE (MANUFACTURER'S COMPANY NAME IF DIFFERENT FROM
                  SUPPLIER):
                </Label>
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange('sourceManufacturer', e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                <Label
                  htmlFor="manufacturersPartNumber"
                  className="text-sm font-semibold"
                >
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange('manufacturersPartNumber', e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                <Label
                  htmlFor="manufacturersLotNumber"
                  className="text-sm font-semibold"
                >
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange('manufacturersLotNumber', e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange('dateOfManufacture', e.target.value)
                  }
                  className="mt-1"
                />
              </div>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleInputChange('dateShippedDelivered', e.target.value)
                  }
                  className="mt-1"
                />
              </div>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleInputChange('specialProcesses', e.target.value)
                }
                className="mt-1"
              />
            </div>
            ...
            <div className="space-y-4 p-4 bg-blue-50 rounded-lg">
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleInputChange('certificationText', e.target.value)
                  }
                  className="mt-1"
                  rows={4}
                />
              ...
              <div>
                ...
                <Textarea
                  ...
                  onChange={(e) =>
                    handleInputChange('otherDataText', e.target.value)
                  }
                  className="mt-1"
                  rows={2}
                />
                ...
                <div>
                  ...
                  <div className="mt-1 text-sm p-2 bg-gray-100 rounded">
                    {formData.signatureDate ||
                      'Date will appear when signature is saved'}
                  </div>
                </div>
              </div>

        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <div className="space-y-2 max-h-60 overflow-y-auto">
              {(() => {
                const lopOrders = identifyLOPOrders(orders).filter(
                  (order) => order.needsLOPAdjustment
                );
          ...
          <div className="p-4 border-2 border-dashed border-gray-300 rounded-lg">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button
                onClick={() => {
                  const updatedOrders = scheduleLOPAdjustments(
                    identifyLOPOrders(orders)
                  );
                  console.log(
                    'Manual LOP scheduling triggered for',
              ...
              <Button
                ...
                onClick={() => {
                  ...
                  if (isMonday) {
                    console.log(
                      'Today is Monday - running immediate LOP scheduling'
                    );
                  } else {
                    console.log(
                      'Not Monday - scheduling deferred until next Monday'
                    );
                  }
                }}
              >
          ...
          <div className="grid grid-cols-2 gap-4">
            {(() => {
              ...
              const scheduled = needingLOP.filter(
                (o) => o.scheduledLOPAdjustmentDate
              );

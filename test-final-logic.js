// Test the final P1 order ID generator logic
...
console.log('\n=== Test with same date and AA005 ===');
const testDate = new Date(2000, 0, 5); // Within first period
const result2 = generateP1OrderId(testDate, 'AA005');

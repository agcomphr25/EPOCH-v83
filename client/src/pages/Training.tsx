    ...
    return (
      <div className="container mx-auto p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">Employee training and certification programs</p>
        </div>
  ...
  return (
    <div className="container mx-auto p-6">
      <div className="mb-6">
        ...
        <p className="text-gray-600">Complete training modules and earn certifications</p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {Array.isArray(modules) && modules.map((module: any) => (
          <Card key={module.id} className="hover:shadow-lg transition-shadow" data-testid={`card-training-module-${module.id}`}>
            <CardHeader>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  ...
                  <span>Estimated Time: {module.estimatedMinutes || 30} minutes</span>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600">
      ...
      {(!modules || (Array.isArray(modules) && modules.length === 0)) && (
        <div className="text-center py-12">
          ...
          <p className="text-gray-400 text-sm mt-2">Check back later for new training content</p>
        </div>
      )}
    </div>
  );

...
export default function FireSafetyTraining() {
  const [participants, setParticipants] = useState<
    Array<{ name: string; signature: string; date: string; department: string }>
  >([
        ...
        <div className="max-w-4xl mx-auto print:max-w-none print-content">
          ...
          <div className="text-center mb-8 print:mb-8 break-inside-avoid">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 print:shadow-none print:border-0 print:rounded-none print:p-0">
              <h1 className="text-4xl font-bold text-center mb-3 print:text-2xl print:mb-2">
                Leader Training Topic:
              </h1>
              <h2 className="text-5xl font-bold text-indigo-600 mb-4 print:text-3xl print:text-black print:mb-4">
                Fire Safety Training
              </h2>
              <p className="text-xl text-gray-600 mb-6 print:text-base print:text-black print:mb-6">
                Essential fire safety procedures and emergency protocols for all
                facility personnel.
              </p>
            </div>
          </div>
          ...
          <div className="space-y-6 mb-8">
            ...
            <Card className="print:shadow-none print:border print:border-gray-400 break-inside-avoid print:mb-4">
              <CardHeader className="bg-blue-50 print:bg-white print:border-b print:border-gray-400 print:p-3">
                <CardTitle className="text-xl text-blue-800 print:text-lg print:text-black print:font-bold">
                  CNC Department
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-4 print:p-3 print:pt-2">
                <ul className="space-y-2 text-sm print:text-sm print:text-black">
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Turn machines to the OFF home position.
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      <ul className="ml-4 mt-1 space-y-1">
                        <li className="flex items-start">
                          <span className="w-1.5 h-1.5 border border-blue-600 rounded-full mt-2 mr-2 flex-shrink-0 sub-bullet-point print:border-black"></span>
                          3 pedestrian exit doors
                        </li>
                        <li className="flex items-start">
                          <span className="w-1.5 h-1.5 border border-blue-600 rounded-full mt-2 mr-2 flex-shrink-0 sub-bullet-point print:border-black"></span>
                          Roll down door
            ...
            <Card className="print:shadow-none print:border print:border-gray-400 break-inside-avoid print:mb-4">
              <CardHeader className="bg-green-50 print:bg-white print:border-b print:border-gray-400 print:p-3">
                <CardTitle className="text-xl text-green-800 print:text-lg print:text-black print:font-bold">
                  Gunsmith Department
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-4 print:p-3 print:pt-2">
                <ul className="space-y-2 text-sm print:text-sm print:text-black">
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-green-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Place all tools and drills in the correct toolbox.
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-green-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Turn all fans OFF.
                  ...
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      <ul className="ml-4 mt-1 space-y-1">
                        <li className="flex items-start">
                          <span className="w-1.5 h-1.5 border border-green-600 rounded-full mt-2 mr-2 flex-shrink-0 sub-bullet-point print:border-black"></span>
                          Turn all grinders OFF.
                        </li>
                        <li className="flex items-start">
                          <span className="w-1.5 h-1.5 border border-green-600 rounded-full mt-2 mr-2 flex-shrink-0 sub-bullet-point print:border-black"></span>
                          Turn fans OFF.
            ...
            <Card className="print:shadow-none print:border print:border-gray-400 break-inside-avoid print:mb-4">
              <CardHeader className="bg-purple-50 print:bg-white print:border-b print:border-gray-400 print:p-3">
                <CardTitle className="text-xl text-purple-800 print:text-lg print:text-black print:font-bold">
                  Plugging & Layup
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-4 print:p-3 print:pt-2">
                <ul className="space-y-2 text-sm print:text-sm print:text-black">
                  <li className="flex items-start">
                    ...
                    <span>
                      ...
                      <ul className="ml-4 mt-1 space-y-1">
                        <li className="flex items-start">
                          <span className="w-1.5 h-1.5 border border-purple-600 rounded-full mt-2 mr-2 flex-shrink-0 sub-bullet-point print:border-black"></span>
                          Break out area
                        </li>
                        <li className="flex items-start">
                          <span className="w-1.5 h-1.5 border border-purple-600 rounded-full mt-2 mr-2 flex-shrink-0 sub-bullet-point print:border-black"></span>
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-purple-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Ensure the oven timers are set to turn OFF.
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-purple-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-purple-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Close the pedestrian exit door.
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="print:shadow-none print:border print:border-gray-400 break-inside-avoid print:mb-4">
              <CardHeader className="bg-orange-50 print:bg-white print:border-b print:border-gray-400 print:p-3">
                <CardTitle className="text-xl text-orange-800 print:text-lg print:text-black print:font-bold">
                  Paint Department
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-4 print:p-3 print:pt-2">
                <ul className="space-y-2 text-sm print:text-sm print:text-black">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-orange-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Clean and break down paint guns.
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-orange-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
            ...
            <Card className="print:shadow-none print:border print:border-gray-400 break-inside-avoid print:mb-4">
              <CardHeader className="bg-red-50 print:bg-white print:border-b print:border-gray-400 print:p-3">
                <CardTitle className="text-xl text-red-800 print:text-lg print:text-black print:font-bold">
                  General Tasks
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-4 print:p-3 print:pt-2">
                <ul className="space-y-2 text-sm print:text-sm print:text-black">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-red-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-red-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Ensure the security gate closes.
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-red-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Check the front office - if you are the last person to
                    leave, set the alarm and lock the front door.
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-red-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Walk through the sanding shed turn off lights and remove
                    tools
                  </li>
                </ul>
              </CardContent>
            ...
            <Card className="print:shadow-none print:border print:border-gray-400 break-inside-avoid print:mb-4">
              <CardHeader className="bg-teal-50 print:bg-white print:border-b print:border-gray-400 print:p-3">
                <CardTitle className="text-xl text-teal-800 print:text-lg print:text-black print:font-bold">
                  Front Office
                </CardTitle>
              </CardHeader>
              <CardContent className="pt-4 print:p-3 print:pt-2">
                <ul className="space-y-2 text-sm print:text-sm print:text-black">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-teal-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                  ...
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-teal-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Ensure hall and porch lights are ON.
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-teal-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Check the back building - if you are the last person to
                    leave, set the alarm and lock the front door.
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-teal-600 rounded-full mt-2 mr-3 flex-shrink-0 bullet-point print:bg-black"></span>
                    Ensure the security gate is closed.
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <CardContent className="print:p-3">
              <div className="space-y-6 print:space-y-4">
                ...
                <div className="space-y-4 print:space-y-3">
                  {[...Array(15)].map((_, index) => (
                    <div
                      key={index}
                      className="border-b border-gray-400 h-8 print:h-6"
                    ></div>
                  ))}
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-8 print:gap-4">
                <div className="space-y-2">
                  <label className="font-semibold text-sm print:text-sm print:text-black">
                    Instructor Signature:
                  </label>

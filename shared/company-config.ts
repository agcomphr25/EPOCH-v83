...
export const CERTIFICATE_TEMPLATES = {
  manufacturersConformance: {
    certificationText:
      'THIS IS TO CERTIFY THAT THE VERTICAL STABILIZER HAS BEEN MANUFACTURED, PROCESSED AND INSPECTED IN ACCORDANCE WITH THE MATERIALS AND PROCEDURES SPECIFIED ON PROVIDED DRAWING. FURTHERMORE, INSPECTION RESULTS SIGNIFY THAT THE TAIL CONE DELIVERED IS FULLY ACCEPTABLE AND IN COMPLETE CONFORMANCE TO ALL SPECIFICATIONS.',
    otherDataText:

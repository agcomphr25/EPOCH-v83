...
export const accountingEventMatrix = [
  {
    ...
    risk: 'LOW',
    evidence: ['server/src/routes/arInvoices.ts', 'server/src/services/arInvoicePostingService.ts', 'server/src/services/accountingPostingService.ts'],
    nextControlAction: 'Verify line-level revenue account mapping for discounts, freight, retainage, and product categories in the shared AR posting service.',
  },
  {
  ...
  },
  {
    ...
    implementationStatus: 'IMPLEMENTED',
    risk: 'HIGH',
    evidence: ['server/src/routes/arInvoices.ts', 'server/src/services/arInvoicePostingService.ts', 'server/src/services/revenueStreamClassifier.ts', 'server/src/services/accountingPostingService.ts'],
    nextControlAction: 'Verify the P1 PO source workflow always creates AR invoices instead of prepaid shipment snapshots.',
  },
  {
    ...
    implementationStatus: 'IMPLEMENTED',
    risk: 'MEDIUM',
    evidence: ['server/src/routes/arInvoices.ts', 'server/src/services/arInvoicePostingService.ts', 'server/src/services/invoiceFromPackingSlip.ts', 'server/src/services/revenueStreamClassifier.ts', 'server/src/services/accountingPostingService.ts'],
    nextControlAction: 'Verify dimension tags for project, lot, packing slip, PO, CLIN, and customer after posting through the shared AR service.',
  },
  {

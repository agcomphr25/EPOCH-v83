...
CREATE TABLE "certifications" (
	"id" integer PRIMARY KEY DEFAULT nextval('certifications_id_seq'::regclass) NOT NULL,
...
CREATE TABLE "employee_certifications" (
	"id" integer PRIMARY KEY DEFAULT nextval('employee_certifications_id_seq'::regclass) NOT NULL,
	"employee_id" integer NOT NULL,

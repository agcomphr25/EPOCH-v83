...
async function initializeBackgroundServices() {
  ...
  try {
    ...
    if (!dbConnected) {
      ...
      try {
        const epochCapabilities = [
          ...
          { key: 'p2.work_orders.view', description: 'View P2 manufacturing work-order queues', category: 'work_orders' },
          { key: 'p2.work_orders.materialize', description: 'Materialize P2 work orders from released Frozen Production Demand', category: 'work_orders' },
          { key: 'p2.work_orders.execute', description: 'Start P2 manufacturing work and travelers', category: 'work_orders' },
          { key: 'p2.work_orders.complete_operation', description: 'Complete P2 routing operations', category: 'work_orders' },
          { key: 'p2.work_orders.accept', description: 'Record controlled Quality acceptance of P2 manufactured output', category: 'work_orders' },
          ...
          { key: 'documents.view', description: 'View controlled documents and exact revisions', category: 'documents' },
          { key: 'documents.create', description: 'Create controlled documents and reserve document numbers', category: 'documents' },
          { key: 'documents.edit_draft', description: 'Edit controlled document draft metadata', category: 'documents' },
          { key: 'documents.submit', description: 'Submit controlled revisions for review', category: 'documents' },
          { key: 'documents.release', description: 'Release approved controlled document revisions', category: 'documents' },
          { key: 'documents.revise', description: 'Create new controlled document revisions', category: 'documents' },
          { key: 'documents.supersede', description: 'Supersede controlled document revisions', category: 'documents' },
          { key: 'documents.obsolete', description: 'Obsolete controlled documents', category: 'documents' },
          { key: 'documents.void', description: 'Void unreleased controlled documents', category: 'documents' },
          { key: 'documents.number_admin', description: 'Reconcile controlled document numbers', category: 'documents' },
          { key: 'documents.reconciliation_view', description: 'View legacy controlled-document reconciliation assessments', category: 'documents' },
          { key: 'documents.reconciliation_preview', description: 'Create explicit legacy reconciliation previews', category: 'documents' },
          { key: 'documents.reconciliation_execute', description: 'Execute deterministic legacy reconciliation backfills', category: 'documents' },
          { key: 'documents.reconciliation_resolve', description: 'Append Quality legacy reconciliation evidence and dispositions', category: 'documents' },
          { key: 'documents.template.create', description: 'Create and reconcile controlled form-template registrations', category: 'documents' },
          { key: 'documents.template.revise', description: 'Create controlled form-template definition revisions', category: 'documents' },
          { key: 'documents.template.release', description: 'Release exact controlled form-template revisions and retained blank artifacts', category: 'documents' },
          { key: 'documents.template.obsolete', description: 'Obsolete released controlled form-template revisions', category: 'documents' },
          { key: 'design.forms.view', description: 'View Design Project controlled form instances', category: 'design' },
          { key: 'design.forms.create', description: 'Create controlled form instances for authoritative Design Projects', category: 'design' },
          { key: 'design.forms.edit', description: 'Edit controlled form-instance drafts', category: 'design' },
          { key: 'design.forms.submit', description: 'Submit immutable form content for authenticated approval', category: 'design' },
          { key: 'design.forms.approve', description: 'Record authenticated form-instance approval decisions', category: 'design' },
          { key: 'design.forms.upload_paper', description: 'Upload immutable original paper-form scans', category: 'design' },
          { key: 'design.forms.supersede', description: 'Supersede controlled form instances with reason', category: 'design' },
          { key: 'engineering.ecr.view', description: 'View Engineering Change Requests', category: 'engineering' },
          { key: 'engineering.ecr.create', description: 'Create Engineering Change Requests', category: 'engineering' },
          { key: 'engineering.ecr.edit', description: 'Edit draft Engineering Change Requests', category: 'engineering' },
          { key: 'engineering.ecr.submit', description: 'Submit immutable Engineering Change Request revisions', category: 'engineering' },
          { key: 'engineering.ecr.review', description: 'Perform Engineering Change Request impact reviews', category: 'engineering' },
          { key: 'engineering.ecr.disposition', description: 'Approve, reject, or return Engineering Change Requests', category: 'engineering' },
          { key: 'engineering.ecr.admin', description: 'Administer cancellations and legacy ECR reconciliation', category: 'engineering' },
          { key: 'engineering.ecn.view', description: 'View authoritative Engineering Change Notices', category: 'engineering' },
          { key: 'engineering.ecn.create', description: 'Create ECNs from approved ECRs', category: 'engineering' },
          { key: 'engineering.ecn.edit', description: 'Edit ECN implementation plans', category: 'engineering' },
          { key: 'engineering.ecn.submit', description: 'Submit immutable ECN content revisions', category: 'engineering' },
          { key: 'engineering.ecn.approve', description: 'Approve or disposition ECN implementation plans', category: 'engineering' },
          { key: 'engineering.ecn.implement', description: 'Execute controlled ECN implementation actions', category: 'engineering' },
          { key: 'engineering.ecn.verify', description: 'Record authenticated ECN verification evidence', category: 'engineering' },
          { key: 'engineering.ecn.validate', description: 'Record authenticated ECN validation evidence', category: 'engineering' },
          { key: 'engineering.ecn.admin', description: 'Administer ECN cancellation and legacy ECO reconciliation', category: 'engineering' },
          { key: 'qms.change_control.view', description: 'View the QMS Change Control register', category: 'qms' },
          { key: 'qms.change_control.create', description: 'Create native Change Control drafts', category: 'qms' },
          { key: 'qms.change_control.import', description: 'Import historical Change Control records', category: 'qms' },
          { key: 'qms.change_control.submit', description: 'Submit Change Control records', category: 'qms' },
          { key: 'qms.change_control.review', description: 'Perform Change Control impact review', category: 'qms' },
          { key: 'qms.change_control.approve', description: 'Approve Change Control records by function', category: 'qms' },
          { key: 'qms.change_control.implement', description: 'Implement approved Change Control records', category: 'qms' },
          { key: 'qms.change_control.verify', description: 'Verify Change Control implementation', category: 'qms' },
          { key: 'qms.change_control.close', description: 'Close verified Change Control records', category: 'qms' },
          { key: 'qms.change_control.reopen', description: 'Reopen closed Change Control records', category: 'qms' },
          { key: 'qms.change_control.admin', description: 'Administer Change Control numbering and import mappings', category: 'qms' },
          { key: 'qms.quality_action.ncr_create', description: 'Create native NCR records through the NCR authority', category: 'qms' },
          { key: 'qms.quality_action.car_create', description: 'Create native CAR/CAPA records through the CAPA authority', category: 'qms' },
          { key: 'qms.quality_action.pcr_create', description: 'Submit native Process Change Requests', category: 'qms' },
          { key: 'qms.quality_action.screen', description: 'Perform Quality Action QMS screening', category: 'qms' },
          { key: 'qms.quality_action.assign_investigation', description: 'Assign Quality Action investigations', category: 'qms' },
          { key: 'qms.quality_action.investigate', description: 'Perform Quality Action investigations', category: 'qms' },
          { key: 'qms.quality_action.assess_impact', description: 'Assess Quality Action impact', category: 'qms' },
          { key: 'qms.quality_action.approve_quality', description: 'Approve PCRs as Quality authority', category: 'qms' },
          { key: 'qms.quality_action.approve_production', description: 'Approve PCRs as Production authority', category: 'qms' },
          { key: 'qms.quality_action.approve_engineering', description: 'Approve PCRs as Engineering authority', category: 'qms' },
          { key: 'qms.quality_action.approve_program_contracts', description: 'Approve PCRs as Program/Contracts authority', category: 'qms' },
          { key: 'qms.quality_action.approve_technical_authority', description: 'Approve PCRs as safety/regulatory technical authority', category: 'qms' },
          { key: 'qms.quality_action.approve_finance', description: 'Approve PCRs when configured cost thresholds apply', category: 'qms' },
          { key: 'qms.quality_action.production_hold', description: 'Control linked production holds', category: 'qms' },
          { key: 'qms.quality_action.authorize_implementation', description: 'Authorize controlled implementation', category: 'qms' },
          { key: 'qms.quality_action.verify_implementation', description: 'Verify controlled implementation', category: 'qms' },
          { key: 'qms.quality_action.close', description: 'Close Quality Action records after verification', category: 'qms' },
          { key: 'qms.quality_action.verify_effectiveness', description: 'Verify CAR/CAPA effectiveness', category: 'qms' },
          { key: 'qms.quality_action.duplicate_admin', description: 'Reconcile duplicate imported records', category: 'qms' },
          { key: 'qms.quality_action.workflow_admin', description: 'Administer Quality Action workflow configuration', category: 'qms' },
          { key: 'engineering.release.view', description: 'View controlled Engineering Releases', category: 'engineering' },
          { key: 'engineering.release.preview', description: 'Preview authoritative release readiness', category: 'engineering' },
          ...
          { key: 'design.dhf.view', description: 'View immutable Design History Files', category: 'design' },
          { key: 'design.dhf.preview', description: 'Preview DHF inclusion readiness', category: 'design' },
          { key: 'design.dhf.generate', description: 'Generate immutable DHF manifests', category: 'design' },
          { key: 'design.dhf.approve', description: 'Approve DHF evidence', category: 'design' },
          { key: 'design.dhf.export', description: 'Create and download protected DHF exports', category: 'design' },
          { key: 'design.dhf.verify', description: 'Verify DHF and export checksums', category: 'design' },
          { key: 'design.dhf.admin', description: 'Administer DHF corrections and legacy limitations', category: 'design' },
          { key: 'engineering.package.view', description: 'View released Engineering Packages', category: 'engineering' },
          { key: 'engineering.package.generate', description: 'Generate released Engineering Packages', category: 'engineering' },
          { key: 'design.control.view', description: 'View authoritative and retained Design Control evidence', category: 'design' },
          { key: 'design.control.create', description: 'Initialize Design Control for an R&D Design Project', category: 'design' },
          { key: 'design.control.admin', description: 'Administer Design Control authority and legacy reconciliation', category: 'design' },
          ...
          { key: 'design.requirement.approve', description: 'Approve Design Control requirements and requirements reviews', category: 'design' },
          { key: 'design.risk.accept', description: 'Accept Design Control risk assessments', category: 'design' },
          { key: 'design.verify', description: 'Approve Design Control verification evidence', category: 'design' },
          { key: 'design.validate', description: 'Approve Design Control validation evidence', category: 'design' },
          { key: 'design.release', description: 'Approve the authenticated Engineering Release Gate', category: 'design' },
          { key: 'design.configuration.view', description: 'View Design Project configurations', category: 'design' },
          { key: 'design.configuration.edit', description: 'Edit draft Design Project configurations', category: 'design' },
          { key: 'design.configuration.applicability.approve', description: 'Approve Design Project documentation applicability', category: 'design' },
          { key: 'design.configuration.revision.review', description: 'Review Design Project part revisions', category: 'design' },
          { key: 'design.configuration.revision.release', description: 'Release Design Project part revisions', category: 'design' },
          { key: 'design.configuration.baseline.create', description: 'Create Engineering Release configuration baselines', category: 'design' },
          { key: 'design.configuration.reconcile', description: 'Reconcile legacy Design Project configuration links', category: 'design' },
          { key: 'design.configuration.admin', description: 'Administer Design Project configuration-control rules', category: 'design' },
    ...
    try {
      ...
      await pool.query(`ALTER TABLE inventory_departments ADD COLUMN IF NOT EXISTS department_code TEXT`);
      await pool.query(`ALTER TABLE inventory_departments ADD COLUMN IF NOT EXISTS routing_enabled BOOLEAN NOT NULL DEFAULT true`);
      await pool.query(`ALTER TABLE inventory_departments ADD COLUMN IF NOT EXISTS production_enabled BOOLEAN NOT NULL DEFAULT true`);
      await pool.query(`ALTER TABLE inventory_departments ADD COLUMN IF NOT EXISTS scheduling_enabled BOOLEAN NOT NULL DEFAULT true`);
      await pool.query(`ALTER TABLE inventory_departments ADD COLUMN IF NOT EXISTS created_by TEXT`);
      await pool.query(`ALTER TABLE inventory_departments ADD COLUMN IF NOT EXISTS updated_by TEXT`);
      await pool.query(`ALTER TABLE inventory_departments ADD COLUMN IF NOT EXISTS created_at TIMESTAMP DEFAULT NOW()`);
      await pool.query(`ALTER TABLE inventory_departments ADD COLUMN IF NOT EXISTS updated_at TIMESTAMP DEFAULT NOW()`);
      await pool.query(`CREATE UNIQUE INDEX IF NOT EXISTS inventory_departments_department_code_uidx ON inventory_departments (lower(department_code)) WHERE department_code IS NOT NULL`);
      await pool.query(`ALTER TABLE inventory_items ADD COLUMN IF NOT EXISTS default_department_id INTEGER REFERENCES inventory_departments(id) ON DELETE RESTRICT`);
      await pool.query(`CREATE INDEX IF NOT EXISTS inventory_items_default_department_id_idx ON inventory_items(default_department_id)`);
      await pool.query(`ALTER TABLE part_routings ADD COLUMN IF NOT EXISTS inventory_item_fk INTEGER REFERENCES inventory_items(id) ON DELETE RESTRICT`);
      await pool.query(`ALTER TABLE part_routings ADD COLUMN IF NOT EXISTS part_revision_snapshot TEXT`);
      await pool.query(`CREATE INDEX IF NOT EXISTS part_routings_inventory_item_fk_idx ON part_routings(inventory_item_fk)`);
      await pool.query(`ALTER TABLE routing_operations ADD COLUMN IF NOT EXISTS department_id INTEGER REFERENCES inventory_departments(id) ON DELETE RESTRICT`);
      await pool.query(`ALTER TABLE routing_operations ADD COLUMN IF NOT EXISTS department_name_snapshot TEXT`);
      await pool.query(`CREATE INDEX IF NOT EXISTS routing_operations_department_id_idx ON routing_operations(department_id)`);
      await pool.query(`CREATE UNIQUE INDEX IF NOT EXISTS routing_operations_routing_step_uidx ON routing_operations(part_routing_id, step_number) WHERE department_id IS NOT NULL`);

...
export function registerRoutes(app: Express): Server {
  ...
  app.post('/api/algorithmic-schedule', async (req, res) => {
    ...
    try {
      ...
      console.error(
        '❌ LAYUP SCHEDULER FLOW: Algorithmic schedule error:',
        error
      );
      res.status(500).json({
        success: false,
  ...
  app.post('/api/push-to-layup-plugging', async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ error: 'Failed to push orders to layup/plugging department' });
    }
  });
  ...
  app.post('/api/production-queue/sync-p1-orders', async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ error: 'Failed to sync P1 orders to production queue' });
    }
  });
  ...
  app.get('/api/production-queue/unified', async (req, res) => {
    try {
      ...
      res
        .status(500)
        .json({ error: 'Failed to fetch unified production queue' });
    }
  });
  ...
  app.post(
    ...
    async (req, res) => {
      ...
      `,
        ...
        res
          .status(500)
          .json({ error: 'Failed to create production orders from PO items' });
      }
    }
  );
  ...
  app.post('/api/pos/:id/calculate-production-schedule', async (req, res) => {
    try {
      ...
      if (poItems.length === 0) {
        return res
          .status(400)
          .json({ error: 'No items found in purchase order' });
      }
      ...
      res
        .status(500)
        .json({ error: 'Failed to calculate production schedule' });
    }
  });
  ...
  const trainingModules = [
    {
      ...
      description:
        'Preservation and Foreign Object Debris prevention procedures',
      estimatedMinutes: 25,
      passingScore: 80,
      ...
      questions: [
        ...
        },
        {
          ...
          answers: [
            { id: 1, answerText: 'Use them anyway', isCorrect: false },
            {
              id: 2,
              answerText:
                'Place in collection area and submit waste management form',
              isCorrect: true,
            },
            { id: 3, answerText: 'Hide them in storage', isCorrect: false },
            {
              id: 4,
              answerText: 'Give them to another department',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'To keep the workplace clean',
              isCorrect: false,
            },
            {
              id: 2,
              answerText:
                'To prevent damage to equipment and ensure product quality',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'To reduce inventory costs',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'To comply with shipping regulations',
              isCorrect: false,
            },
          ],
        },
          ...
          answers: [
            {
              id: 1,
              answerText:
                'In sealed bags or containers with proper identification',
              isCorrect: true,
            },
            {
              id: 2,
              answerText: 'Anywhere on the shop floor',
              isCorrect: false,
            },
            {
              id: 3,
              answerText: 'In open bins for easy access',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'Mixed with other parts to save space',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            ...
            {
              id: 2,
              answerText: 'Only if someone gets hurt',
              isCorrect: false,
            },
            {
              id: 3,
              answerText: 'Immediately when discovered',
              isCorrect: true,
            },
            {
              id: 4,
              answerText: 'During the monthly safety meeting',
              isCorrect: false,
            },
          ],
        },
      ...
      questions: [
        ...
        },
        {
          ...
          answers: [
            { id: 1, answerText: 'Safety glasses only', isCorrect: false },
            {
              id: 2,
              answerText:
                'Gloves and safety glasses at minimum, as specified in SDS',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'No PPE needed for small amounts',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'Only gloves are necessary',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'Alphabetically for easy finding',
              isCorrect: false,
            },
            {
              id: 2,
              answerText: 'By compatibility groups in approved cabinets',
              isCorrect: true,
            },
            { id: 3, answerText: 'Under the sink', isCorrect: false },
            {
              id: 4,
              answerText: 'All chemicals can be stored together',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'Evacuate the area and notify supervisor immediately',
              isCorrect: true,
            },
            {
              id: 2,
              answerText: 'Clean it up quickly with paper towels',
              isCorrect: false,
            },
            { id: 3, answerText: 'Ignore small spills', isCorrect: false },
            {
              id: 4,
              answerText: 'Dilute with water and wipe up',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'Pour down the drain with water',
              isCorrect: false,
            },
            { id: 2, answerText: 'Place in regular trash', isCorrect: false },
            {
              id: 3,
              answerText:
                'According to SDS and waste management procedures in proper containers',
              isCorrect: true,
            },
            {
              id: 4,
              answerText: 'Leave for the cleaning crew',
              isCorrect: false,
            },
          ],
        },
      ...
      questions: [
        {
          ...
          answers: [
            ...
            {
              id: 3,
              answerText: 'Prepare, Activate, Spray, Secure',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'Pull, Activate, Spray, Sweep',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            { id: 1, answerText: 'On any size fire', isCorrect: false },
            {
              id: 2,
              answerText:
                'Only on small, contained fires with a clear escape route',
              isCorrect: true,
            },
            { id: 3, answerText: 'After calling 911', isCorrect: false },
            {
              id: 4,
              answerText: 'Only if trained firefighters are not available',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'Try to put it out yourself',
              isCorrect: false,
            },
            {
              id: 2,
              answerText: 'Activate the fire alarm and evacuate',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'Take photos for documentation',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'Move equipment away from the fire',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            ...
            {
              id: 3,
              answerText: 'At the center of the fire',
              isCorrect: false,
            },
        ...
        },
        {
          ...
          answers: [
            ...
            {
              id: 3,
              answerText: 'Try to pat it out with your hands',
              isCorrect: false,
            },
      ...
      questions: [
        ...
        },
        {
          ...
          answers: [
            ...
            {
              id: 4,
              answerText: 'Customs and Border Protection',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'Only physical shipment of items overseas',
              isCorrect: false,
            },
            {
              id: 2,
              answerText:
                'Transfer of technical data or defense articles to foreign persons, even in the US',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'Selling products to foreign governments only',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'International travel with company equipment',
              isCorrect: false,
            },
          ],
        },
        {
          id: 4,
          question:
            'What should you do if a foreign visitor requests access to controlled technical data?',
          answers: [
            {
              id: 1,
              answerText: 'Provide the information if they seem trustworthy',
              isCorrect: false,
            },
            {
              id: 2,
              answerText:
                'Immediately notify management and compliance officer',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'Email the information to their home country',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'Share general information but not specific details',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            { id: 1, answerText: 'Minor fines only', isCorrect: false },
            {
              id: 2,
              answerText:
                'Criminal penalties including imprisonment and civil fines up to $1 million per violation',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'Written warning for first offense',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'Loss of security clearance only',
              isCorrect: false,
            },
          ],
        },
      ...
      questions: [
          ...
          answers: [
            {
              id: 1,
              answerText:
                'Continuously improve while producing quality products in a timely manner to meet customer requirements',
              isCorrect: true,
            },
            {
              id: 2,
              answerText: 'Make products as fast as possible',
              isCorrect: false,
            },
            {
              id: 3,
              answerText: 'Reduce costs at all times',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'Meet deadlines no matter what',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'The company has the cheapest prices',
              isCorrect: false,
            },
            {
              id: 2,
              answerText:
                'Commitment to quality management in aerospace manufacturing',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'The company is the largest in the industry',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'Products are made in the USA',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: "Fix it quietly and don't tell anyone",
              isCorrect: false,
            },
            {
              id: 2,
              answerText:
                'Report it immediately to your supervisor or quality department',
              isCorrect: true,
            },
            { id: 3, answerText: "Ignore it if it's small", isCorrect: false },
            {
              id: 4,
              answerText: 'Wait until the end of the shift',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            ...
            {
              id: 2,
              answerText: 'To ensure consistent quality and proper procedures',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'For decoration on the wall',
              isCorrect: false,
            },
        ...
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'Only the quality department',
              isCorrect: false,
            },
            { id: 2, answerText: 'Only management', isCorrect: false },
            {
              id: 3,
              answerText: 'Every employee in the company',
              isCorrect: true,
            },
      ...
      questions: [
        {
          ...
          answers: [
            ...
            {
              id: 4,
              answerText: 'Unauthorized distributors',
              isCorrect: false,
            },
          ],
        },
          ...
          answers: [
            {
              id: 1,
              answerText:
                'Poor packaging, incorrect markings, or unusually low prices',
              isCorrect: true,
            },
            { id: 2, answerText: 'All imported parts', isCorrect: false },
            {
              id: 3,
              answerText: 'Parts from authorized distributors',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'Parts with complete documentation',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            { id: 1, answerText: 'Use it anyway if it fits', isCorrect: false },
            {
              id: 2,
              answerText:
                'Quarantine the part and notify quality/purchasing immediately',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'Return it to the supplier without documentation',
              isCorrect: false,
            },
        ...
        },
        {
          ...
          answers: [
            ...
            {
              id: 2,
              answerText: 'Safety, reliability, and regulatory compliance',
              isCorrect: true,
            },
            { id: 3, answerText: 'To reduce paperwork', isCorrect: false },
            {
              id: 4,
              answerText: "It's not really important",
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            { id: 1, answerText: 'Just the packing slip', isCorrect: false },
            {
              id: 2,
              answerText:
                'Certificate of Conformance, test reports, and source verification',
              isCorrect: true,
            },
      ...
      questions: [
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'Report it to management immediately',
              isCorrect: true,
            },
            ...
            {
              id: 4,
              answerText: 'Wait to see if it happens again',
              isCorrect: false,
            },
          ],
        },
        {
          id: 2,
          question:
            'What is an example of unethical behavior in manufacturing?',
          answers: [
            { id: 1, answerText: 'Following all procedures', isCorrect: false },
            {
              id: 2,
              answerText: 'Falsifying inspection records or test results',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'Reporting safety concerns',
              isCorrect: false,
            },
        ...
        },
        {
          ...
          answers: [
            { id: 1, answerText: 'It makes work easier', isCorrect: false },
            {
              id: 2,
              answerText:
                'Lives depend on the integrity and safety of our products',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: "It's only important for management",
              isCorrect: false,
            },
        ...
        },
        {
          id: 4,
          question:
            "What should you do if you're asked to skip a quality check to meet a deadline?",
          answers: [
            { id: 1, answerText: 'Skip it to help the team', isCorrect: false },
            {
              id: 2,
              answerText: 'Refuse and report the request to management',
              isCorrect: true,
            },
            { id: 3, answerText: 'Skip it just this once', isCorrect: false },
            {
              id: 4,
              answerText: "Do the check later when there's time",
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: "To report people you don't like",
              isCorrect: false,
            },
            {
              id: 2,
              answerText:
                'To anonymously report concerns about unethical or illegal behavior',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'To complain about working conditions',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'To report equipment problems',
              isCorrect: false,
            },
          ],
        },
      ...
      questions: [
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'Quarantine it and notify quality control',
              isCorrect: true,
            },
        ...
        },
        {
          ...
          answers: [
            { id: 1, answerText: 'To hide mistakes', isCorrect: false },
            {
              id: 2,
              answerText:
                'To prevent unauthorized use and allow proper disposition',
              isCorrect: true,
            },
        ...
        },
        {
          id: 3,
          question:
            'Who has the authority to disposition a nonconforming item?',
          answers: [
            { id: 1, answerText: 'Any employee', isCorrect: false },
            {
              id: 2,
              answerText: 'Only the quality manager or authorized personnel',
              isCorrect: true,
            },
            { id: 3, answerText: 'The person who found it', isCorrect: false },
            {
              id: 4,
              answerText: 'The production supervisor only',
              isCorrect: false,
            },
          ],
        },
        {
          id: 4,
          question:
            'What are the possible dispositions for nonconforming items?',
          answers: [
            {
              id: 1,
              answerText: 'Use as-is, rework, scrap, or return to supplier',
              isCorrect: true,
            },
            ...
            {
              id: 4,
              answerText: 'Hide it and forget about it',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            { id: 1, answerText: "It's not important", isCorrect: false },
            {
              id: 2,
              answerText:
                'For traceability, trend analysis, and continuous improvement',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'To blame specific employees',
              isCorrect: false,
            },
      ...
      questions: [
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'Remove all tools from spindles',
              isCorrect: true,
            },
        ...
        },
        {
          id: 2,
          question:
            'What should be done with work in progress (WIP) at end of shift?',
          answers: [
            { id: 1, answerText: 'Leave it on the machine', isCorrect: false },
            {
              id: 2,
              answerText:
                'Store it properly in designated WIP area with identification',
              isCorrect: true,
            },
        ...
        },
        {
          id: 3,
          question:
            'Why is it important to clean your work area at end of shift?',
          answers: [
            { id: 1, answerText: 'To make it look nice', isCorrect: false },
            {
              id: 2,
              answerText:
                'For safety, FOD prevention, and next shift readiness',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'Only if the boss is watching',
              isCorrect: false,
            },
        ...
        },
        {
          ...
          answers: [
            ...
            {
              id: 2,
              answerText: 'Turn off and bleed down air lines',
              isCorrect: true,
            },
            {
              id: 3,
              answerText: 'Increase pressure for next shift',
              isCorrect: false,
            },
            {
              id: 4,
              answerText: 'Nothing, it turns off automatically',
              isCorrect: false,
            },
          ],
        },
        {
          ...
          answers: [
            {
              id: 1,
              answerText: 'Turn off lights and verify all equipment is secure',
              isCorrect: true,
            },
            { id: 2, answerText: 'Just walk out', isCorrect: false },
            {
              id: 3,
              answerText: 'Lock yourself in overnight',
              isCorrect: false,
            },

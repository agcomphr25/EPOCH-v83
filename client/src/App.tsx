...
const InventoryScannerPage = React.lazy(
  () => import('./pages/InventoryScannerPage')
);
const InventoryDashboardPage = React.lazy(
  () => import('./pages/InventoryDashboardPage')
);
const InventoryManagerPage = React.lazy(
  () => import('./pages/InventoryManagerPage')
);
const InventoryLedgerPage = React.lazy(
  () => import('./pages/InventoryLedgerPage')
);
const InventoryTraceabilityPage = React.lazy(
  () => import('./pages/InventoryTraceabilityPage')
);
const InventoryReceivingPage = React.lazy(
  () => import('./pages/InventoryReceivingPage')
);
const InventoryReceivingControlCenter = React.lazy(
  () => import('./pages/InventoryReceivingControlCenter')
);
const InventoryReceivingPageLegacy = React.lazy(
  () => import('./pages/InventoryReceivingPageLegacy')
);
const EnhancedInventoryMRPPage = React.lazy(
  () => import('./pages/EnhancedInventoryMRPPage')
);
const MaterialReadinessDashboard = React.lazy(
  () => import('./pages/MaterialReadinessDashboard')
);
const MaterialIntelligenceDashboard = React.lazy(
  () => import('./pages/MaterialIntelligenceDashboard')
);
const DepartmentPartsRequestPage = React.lazy(
  () => import('./pages/DepartmentPartsRequestPage')
);
const PartsRequestsCard = React.lazy(
  () => import('./components/inventory/PartsRequestsCard')
);
const ConsolidatedNeedsListPage = React.lazy(
  () => import('./pages/ConsolidatedNeedsListPage')
);
...
const SignedDocumentsLibrary = React.lazy(
  () => import('./pages/SignedDocumentsLibrary')
);
const SignatureWorkflowPage = React.lazy(
  () => import('./pages/SignatureWorkflowPage')
);
...
const PoliciesAdminPage = React.lazy(
...
const ProductionStationDashboard = React.lazy(
...
const TicketsCommandCenter = React.lazy(
  () => import('./pages/TicketsCommandCenter')
);
...
const MaintenanceEventsPage = React.lazy(
  () => import('./pages/MaintenanceEventsPage')
);
const WorkOrderDetailPage = React.lazy(
  () => import('./pages/WorkOrderDetailPage')
);
...
const WADStatusDashboard = React.lazy(
  () => import('./pages/WADStatusDashboard')
);
const WADSummaryPage = React.lazy(() => import('./pages/WADSummaryPage'));
const AssetsPage = React.lazy(() => import('./pages/AssetsPage'));
const AssetDashboardPage = React.lazy(
  () => import('./pages/AssetDashboardPage')
);
const QMSPlaceholderPage = React.lazy(
  () => import('./pages/QMSPlaceholderPage')
);
...
const QMSDesignControlPage = React.lazy(
  () => import('./pages/QMSDesignControlPage')
);
const QMSPartsEquipmentPage = React.lazy(
  () => import('./pages/QMSPartsEquipmentPage')
);
const AS9100AuditReadinessPage = React.lazy(
  () => import('./pages/AS9100AuditReadinessPage')
);
const EpochSoftwareValidationPage = React.lazy(
  () => import('./pages/EpochSoftwareValidationPage')
);
const EmployeePortalPage = React.lazy(
  () => import('./pages/EmployeePortalPage')
);
const KioskPage = React.lazy(() => import('./pages/timekeeping/KioskPage'));
const TimeClockAdminPage = React.lazy(
  () => import('./pages/timekeeping/TimeClockAdminPage')
);
const SalariedTimeEntryPage = React.lazy(
  () => import('./pages/timekeeping/SalariedTimeEntryPage')
);
const SalariedDraftListPage = React.lazy(
  () => import('./pages/timekeeping/SalariedDraftListPage')
);
...
const CommunicationInboxPage = React.lazy(
  () => import('./pages/CommunicationInboxPage')
);
const MarketingCommunications = React.lazy(
  () => import('./pages/MarketingCommunications')
);
...
const FinancialReviewPage = React.lazy(
  () => import('./pages/FinancialReviewPage')
);
const FinancialReviewListPage = React.lazy(
  () => import('./pages/FinancialReviewListPage')
);
const FinancialReviewSlidePage = React.lazy(
  () => import('./pages/FinancialReviewSlidePage')
);
const CostCenterManagement = React.lazy(
  () => import('./pages/CostCenterManagement')
);
const CostAccountingPage = React.lazy(
  () => import('./pages/CostAccountingPage')
);
...
const MonthlyFulfilledReport = React.lazy(
  () => import('./pages/MonthlyFulfilledReport')
);
const MonthlyShippedReport = React.lazy(
  () => import('./pages/MonthlyShippedReport')
);
const POProductionOrdersReport = React.lazy(
  () => import('./pages/POProductionOrdersReport')
);
const BulkPaymentPage = React.lazy(() => import('./pages/BulkPaymentPage'));
const BulkPaymentHistoryPage = React.lazy(
  () => import('./pages/BulkPaymentHistoryPage')
);
const PaymentReconciliationPage = React.lazy(
  () => import('./pages/PaymentReconciliationPage')
);
const AccountingPage = React.lazy(() => import('./pages/AccountingPage'));
const AccountingControlCenter = React.lazy(
  () => import('./pages/AccountingControlCenter')
);
const PayrollControlPage = React.lazy(
  () => import('./pages/finance/PayrollControlPage')
);
const EmployeeBadgeConfiguration = React.lazy(
  () => import('./pages/EmployeeBadgeConfiguration')
);
const BadgeScanner = React.lazy(() => import('./pages/BadgeScanner'));
const OnboardingDashboard = React.lazy(
  () => import('./pages/OnboardingDashboard')
);
const OnboardingInvitePage = React.lazy(
  () => import('./pages/OnboardingInvitePage')
);
const OnboardingPathsPage = React.lazy(
  () => import('./pages/OnboardingPathsPage')
);
const OnboardingSettingsPage = React.lazy(
  () => import('./pages/OnboardingSettingsPage')
);
const EmployerSignaturesPage = React.lazy(
  () => import('./pages/EmployerSignaturesPage')
);
const OnboardingFormsPage = React.lazy(
  () => import('./pages/OnboardingFormsPage')
);
const OnboardingSessionWizard = React.lazy(
  () => import('./pages/OnboardingSessionWizard')
);
const EnhancedFormsPage = React.lazy(() => import('./pages/EnhancedFormsPage'));
const EnhancedReportsPage = React.lazy(
  () => import('./pages/EnhancedReportsPage')
);
const FormRendererPage = React.lazy(() => import('./pages/FormRendererPage'));
const DocumentationPageNew = React.lazy(
  () => import('./pages/DocumentationPageNew')
);
...
const P2PackingSlipViewer = React.lazy(
  () => import('./pages/P2PackingSlipViewer')
);
const P2POViewer = React.lazy(() => import('./pages/P2POViewer'));
const P2CertificateViewer = React.lazy(
  () => import('./pages/P2CertificateViewer')
);
...
const P2MaterialTransferForm = React.lazy(
  () => import('./pages/P2MaterialTransferForm')
);
const P2TestReportViewer = React.lazy(
  () => import('./pages/P2TestReportViewer')
);
const P2ReadyToShipDashboard = React.lazy(
  () => import('./pages/P2ReadyToShipDashboard')
);
...
const ProductionTracking = React.lazy(
  () => import('./pages/ProductionTracking')
);
const CustomerWIPPage = React.lazy(() => import('./pages/CustomerWIPPage'));
const BarcodeScannerPage = React.lazy(
  () => import('./pages/BarcodeScannerPage')
);
const AllOrdersPage = React.lazy(() => import('./pages/AllOrdersPage'));
const OrderReports = React.lazy(() => import('./pages/OrderReports'));
const ProductionOrderInspector = React.lazy(
  () => import('./pages/ProductionOrderInspector')
);
const DomainTruthInspector = React.lazy(
  () => import('./pages/DomainTruthInspector')
);
const QueueIntegrityMonitor = React.lazy(
  () => import('./pages/admin/QueueIntegrityMonitor')
);
const ShippingStatusAuditPage = React.lazy(
  () => import('./pages/admin/ShippingStatusAuditPage')
);
const P1POStatusRepairPage = React.lazy(
  () => import('./pages/admin/P1POStatusRepairPage')
);
const ProductionControlTower = React.lazy(
  () => import('./pages/admin/ProductionControlTower')
);
const LocateOrder = React.lazy(() => import('./pages/LocateOrder'));
const LinkGroupsReport = React.lazy(() => import('./pages/LinkGroupsReport'));
const DueDateCapacityReport = React.lazy(
  () => import('./pages/DueDateCapacityReport')
);
const AnalyticsDashboard = React.lazy(
  () => import('./pages/AnalyticsDashboard')
);
const QuoteAccuracyDashboard = React.lazy(
  () => import('./pages/QuoteAccuracyDashboard')
);
const AGTestDashboard = React.lazy(() => import('./pages/AGTestDashboard'));
const ADMINTestDashboard = React.lazy(
  () => import('./pages/GLENNTestDashboard')
);
const AdminDashboardPreview = React.lazy(
  () => import('./pages/AdminDashboardPreview')
);
const ProductionCommandCenter = React.lazy(
  () => import('./pages/ProductionCommandCenter')
);
const ProductionControlCenter = React.lazy(
  () => import('./pages/ProductionControlCenter')
);
const ProductionControlCenterLive = React.lazy(
  () => import('./pages/ProductionControlCenterLive')
);
const DailyThroughputBoard = React.lazy(
  () => import('./pages/DailyThroughputBoard')
);
const JOHNLTestDashboard = React.lazy(
  () => import('./pages/JOHNLTestDashboard')
);
const JENSTestDashboard = React.lazy(() => import('./pages/JENSTestDashboard'));
const STACIWTestDashboard = React.lazy(
  () => import('./pages/STACIWTestDashboard')
);
const DARLENEBTestDashboard = React.lazy(
  () => import('./pages/DARLENEBTestDashboard')
);
const LAURIETTestDashboard = React.lazy(
  () => import('./pages/LAURIETTestDashboard')
);
...
const BRADWTestDashboard = React.lazy(
  () => import('./pages/BRADWTestDashboard')
);
const CHASEWTestDashboard = React.lazy(
  () => import('./pages/CHASEWTestDashboard')
);
const FALEESHAHTestDashboard = React.lazy(
  () => import('./pages/FALEESHAHTestDashboard')
);
...
const JOEYBTestDashboard = React.lazy(
  () => import('./pages/JOEYBTestDashboard')
);
const ANGIETTestDashboard = React.lazy(
  () => import('./pages/ANGIETTestDashboard')
);
const TANDYMTestDashboard = React.lazy(
  () => import('./pages/TANDYMTestDashboard')
);
const OrderDepartmentTransfer = React.lazy(
  () => import('./pages/OrderDepartmentTransfer')
);
const BOMAdministration = React.lazy(() =>
  import('./pages/BOMAdministration').then((m) => ({
    default: m.BOMAdministration,
  }))
);
const RobustBOMAdministration = React.lazy(
  () => import('./pages/RobustBOMAdministration')
);
const AGBottomMetalReport = React.lazy(
  () => import('./pages/AGBottomMetalReport')
);
...
const MasterDocumentRegister = React.lazy(
  () => import('@/pages/MasterDocumentRegister')
);
const WasteManagementForm = React.lazy(
  () => import('@/pages/WasteManagementForm')
);
const TaskTracker = React.lazy(() => import('@/pages/TaskTracker'));
const KickbackTracking = React.lazy(
  () => import('@/components/KickbackTracking')
);
const DocumentManagement = React.lazy(
  () => import('./pages/DocumentManagement')
);
const RoutingDocumentManagement = React.lazy(
  () => import('./pages/RoutingDocumentManagement')
);
const RoutingTemplates = React.lazy(() => import('./pages/RoutingTemplates'));
const TemplateLibraryPage = React.lazy(
  () => import('./pages/TemplateLibraryPage')
);
const AnodizeJobs = React.lazy(() => import('./pages/AnodizeJobs'));
const ShutdownProceduresTraining = React.lazy(
  () => import('@/pages/ShutdownProceduresTraining')
);
const CounterfeitPreventionTraining = React.lazy(
  () => import('@/pages/CounterfeitPreventionTraining')
);
const TrainingControlCenter = React.lazy(
  () => import('@/pages/TrainingControlCenter')
);
...
const TraineeTrainingPortal = React.lazy(
  () => import('@/pages/TraineeTrainingPortal')
);
const TrainingContentLibrary = React.lazy(
  () => import('@/pages/TrainingContentLibrary')
);
const ProgramsPage = React.lazy(() =>
  import('@/modules/training-builder').then((m) => ({
    default: m.ProgramsPage,
  }))
);
const ProgramBuilderPage = React.lazy(() =>
  import('@/modules/training-builder').then((m) => ({
    default: m.ProgramBuilderPage,
  }))
);
const AssignProgramPage = React.lazy(() =>
  import('@/modules/training-builder').then((m) => ({
    default: m.AssignProgramPage,
  }))
);
const SessionDailySheetPage = React.lazy(() =>
  import('@/modules/training-builder').then((m) => ({
    default: m.SessionDailySheetPage,
  }))
);
const WorkInstructionsPage = React.lazy(() =>
  import('@/modules/training-builder').then((m) => ({
    default: m.WorkInstructionsPage,
  }))
);
const QuizManagementPage = React.lazy(() =>
  import('@/modules/training-builder').then((m) => ({
    default: m.QuizManagementPage,
  }))
);
const DailyQuizSelectionPage = React.lazy(() =>
  import('@/modules/training-builder').then((m) => ({
    default: m.DailyQuizSelectionPage,
  }))
);
const ImportCertifications = React.lazy(
  () => import('@/pages/ImportCertifications')
);
const CertificationBacklog = React.lazy(
  () => import('@/pages/CertificationBacklog')
);
...
const LayupPluggingQueuePage = React.lazy(
  () => import('./pages/LayupPluggingQueuePage')
);
const BarcodeQueuePage = React.lazy(() => import('./pages/BarcodeQueuePage'));
const BulkBarcodeReprint = React.lazy(
  () => import('./pages/BulkBarcodeReprint')
);
const CNCQueuePage = React.lazy(() => import('./pages/CNCQueuePage'));
const CNCDashboardPage = React.lazy(() => import('./pages/CNCDashboardPage'));
const CNCPartRoutingsPage = React.lazy(
  () => import('./pages/CNCPartRoutingsPage')
);
const CNCOperationBatchStation = React.lazy(
  () => import('./pages/CNCOperationBatchStation')
);
...
const FinishQCCompletedReport = React.lazy(
  () => import('./pages/FinishQCCompletedReport')
);
...
const QCShippingQueuePage = React.lazy(
  () => import('./pages/QCShippingQueuePage')
);
...
const NonconformanceDashboard = React.lazy(
  () => import('./components/NonconformanceDashboard')
);
const NonconformanceReport = React.lazy(
  () => import('./components/NonconformanceReport')
);
const RTSPage = React.lazy(() => import('./pages/RTSPage'));
const RFQRiskAssessment = React.lazy(() => import('./pages/RFQRiskAssessment'));
const ConversationalRFQRiskAssessment = React.lazy(
  () => import('./pages/ConversationalRFQRiskAssessment')
);
const ProductionQueueManager = React.lazy(
  () => import('./components/ProductionQueueManager')
);
const EnhancedLayupSchedulerPage = React.lazy(
  () => import('./pages/EnhancedLayupSchedulerPage')
);
const WorkDayAwareScheduler = React.lazy(
  () => import('./components/WorkDayAwareScheduler')
);
const PurchaseReviewChecklist = React.lazy(
  () => import('./pages/PurchaseReviewChecklist')
);
const PurchaseReviewSubmissions = React.lazy(
  () => import('./pages/PurchaseReviewSubmissions')
);
const ManufacturersCertificate = React.lazy(
  () => import('./pages/ManufacturersCertificate')
);
...
const HistoricalDataEntry = React.lazy(
  () => import('./pages/HistoricalDataEntry')
);
const ShippedOrderDiscountsPage = React.lazy(
  () => import('./pages/ShippedOrderDiscountsPage')
);
const InvoiceCategoryBreakdownPage = React.lazy(
  () => import('./pages/InvoiceCategoryBreakdownPage')
);
const ScrapReportPage = React.lazy(() => import('./pages/ScrapReportPage'));
const ChargeCodeManagerPage = React.lazy(
  () => import('./pages/finance/ChargeCodeManagerPage')
);
...
const ProductionQueuePage = React.lazy(
  () => import('./pages/ProductionQueuePage')
);
const SimplifiedLayupScheduler = React.lazy(
  () => import('./components/SimplifiedLayupScheduler')
);
const CustomerSatisfaction = React.lazy(
  () => import('./pages/CustomerSatisfaction')
);
const AdminPanelPage = React.lazy(() => import('./pages/AdminPanelPage'));
const AdminChecklistManagementPage = React.lazy(
  () => import('./pages/AdminChecklistManagementPage')
);
const RolesPermissionsPage = React.lazy(
  () => import('./pages/admin/RolesPermissionsPage')
);
const OperatorAuthSessionsPage = React.lazy(
  () => import('./pages/admin/OperatorAuthSessionsPage')
);
const OrderLookupPage = React.lazy(
  () => import('./pages/admin/OrderLookupPage')
);
const OrderOverridePage = React.lazy(
  () => import('./pages/admin/OrderOverridePage')
);
const WidgetCatalogPage = React.lazy(
  () => import('./pages/admin/WidgetCatalogPage')
);
const ProductionForecastPage = React.lazy(
...
const CommunicationLogsPage = React.lazy(
  () => import('./pages/CommunicationLogsPage')
);
const MonitoredLinksManager = React.lazy(
  () => import('./pages/MonitoredLinksManager')
);
const VendorsPage = React.lazy(() => import('./pages/VendorsPage'));
const PurchaseRequisitionsPage = React.lazy(
  () => import('./pages/PurchaseRequisitionsPage')
);
const VendorPOPage = React.lazy(() => import('./pages/VendorPOPage'));
const VendorPOComplianceBackfillPage = React.lazy(
  () => import('./pages/VendorPOComplianceBackfillPage')
);
const PDFTemplateManager = React.lazy(
  () => import('./pages/PDFTemplateManager')
);
const CuttingControlCenterLayout = React.lazy(
  () => import('./pages/cutting/CuttingControlCenterLayout')
);
const FabricInventoryPage = React.lazy(
  () => import('./pages/FabricInventoryPage')
);
const MetalAccessoriesTracker = React.lazy(
  () => import('./pages/MetalAccessoriesTracker')
);
...
const AttentionDashboard = React.lazy(
  () => import('./pages/AttentionDashboard')
);
const FillablePdfTemplatesAdmin = React.lazy(
  () => import('./pages/FillablePdfTemplatesAdmin')
);
const VisualFieldEditor = React.lazy(() => import('./pages/VisualFieldEditor'));
const PdfFormsPage = React.lazy(() => import('./pages/PdfFormsPage'));
const PdfFormsEditorPage = React.lazy(
  () => import('./pages/PdfFormsEditorPage')
);
...
const PreproductionChecklistPage = React.lazy(
  () => import('./pages/PreproductionChecklistPage')
);
const ProjectsPage = React.lazy(() => import('./pages/ProjectsPage'));
const ProjectDetailPage = React.lazy(() => import('./pages/ProjectDetailPage'));
const ProjectClosingRecordPage = React.lazy(
  () => import('./pages/ProjectClosingRecordPage')
);
const P2PipelineBoardPage = React.lazy(
  () => import('./pages/P2PipelineBoardPage')
);
const PMControlCenterPage = React.lazy(
  () => import('./pages/PMControlCenterPage')
);
const HelpCenter = React.lazy(() => import('./pages/HelpCenter'));
const P2OrderGuide = React.lazy(() => import('./pages/P2OrderGuide'));
const TimeclockTrainingProgramGuide = React.lazy(
  () => import('./pages/TimeclockTrainingProgramGuide')
);
const PTORequestGuide = React.lazy(() => import('./pages/PTORequestGuide'));
const PunchEditRequestGuide = React.lazy(
  () => import('./pages/PunchEditRequestGuide')
);
const TimesheetReviewGuide = React.lazy(
  () => import('./pages/TimesheetReviewGuide')
);
const TravelerManagement = React.lazy(
  () => import('./pages/TravelerManagement')
);
const TravelerExecution = React.lazy(() => import('./pages/TravelerExecution'));
const MaterialReceivingPage = React.lazy(
  () => import('./pages/MaterialReceivingPage')
);
const MaterialInventoryPage = React.lazy(
  () => import('./pages/MaterialInventoryPage')
);
const InventoryRestockSignalsPage = React.lazy(
  () => import('./pages/InventoryRestockSignalsPage')
);
const InventoryReconciliationPage = React.lazy(
  () => import('./pages/InventoryReconciliationPage')
);
const CycleCountPage = React.lazy(() => import('./pages/CycleCountPage'));
const FilteredOrdersReport = React.lazy(
  () => import('./pages/FilteredOrdersReport')
);
const UrgentOrdersReport = React.lazy(
  () => import('./pages/UrgentOrdersReport')
);
...
const DraftBOMBuilderPage = React.lazy(
  () => import('./pages/DraftBOMBuilderPage')
);
...
const InventoryAnomalyDashboard = React.lazy(
  () => import('./pages/InventoryAnomalyDashboard')
);
const AnomalyDetectorConfigPage = React.lazy(
  () => import('./pages/AnomalyDetectorConfigPage')
);
const ApprovalsInbox = React.lazy(() => import('./pages/ApprovalsInbox'));
const EscalationPoliciesPage = React.lazy(
  () => import('./pages/admin/EscalationPoliciesPage')
);
const CommandCenter = React.lazy(() => import('./pages/CommandCenter'));
const EdriDashboard = React.lazy(() => import('./pages/admin/EdriDashboard'));
const EdriDomainDetail = React.lazy(
  () => import('./pages/admin/EdriDomainDetail')
);
const EdriRedFlags = React.lazy(() => import('./pages/admin/EdriRedFlags'));
const EdriRemediation = React.lazy(
  () => import('./pages/admin/EdriRemediation')
);
const EdriHeatmap = React.lazy(() => import('./pages/admin/EdriHeatmap'));
const EdriMissingEvidence = React.lazy(
  () => import('./pages/admin/EdriMissingEvidence')
);
const EdriHistory = React.lazy(() => import('./pages/admin/EdriHistory'));
const EdriEvidence = React.lazy(() => import('./pages/admin/EdriEvidence'));
const EdriSnapshotDetail = React.lazy(
  () => import('./pages/admin/EdriSnapshotDetail')
);
const EdriSupportingDocs = React.lazy(
  () => import('./pages/admin/EdriSupportingDocs')
);
...
const ChargeCodeUsageReport = React.lazy(
  () => import('./pages/admin/ChargeCodeUsageReport')
);
const LaborDistributionReport = React.lazy(
  () => import('./pages/admin/LaborDistributionReport')
);
const TransactionEvidenceMap = React.lazy(
  () => import('./pages/admin/TransactionEvidenceMap')
);
const SupervisorApprovalExceptionReport = React.lazy(
  () => import('./pages/admin/SupervisorApprovalExceptionReport')
);
const TimesheetCorrectionLogReport = React.lazy(
  () => import('./pages/admin/TimesheetCorrectionLogReport')
);
const PayrollExportReconciliationReport = React.lazy(
  () => import('./pages/admin/PayrollExportReconciliationReport')
);
const IndirectCostBurdenRateReport = React.lazy(
  () => import('./pages/admin/IndirectCostBurdenRateReport')
);
const UnallowableCostReviewReport = React.lazy(
  () => import('./pages/admin/UnallowableCostReviewReport')
);
const ProcurementComplianceReport = React.lazy(
  () => import('./pages/admin/ProcurementComplianceReport')
);
const InventoryTraceabilityReport = React.lazy(
  () => import('./pages/admin/InventoryTraceabilityReport')
);
const AuditLedgerIntegrityReport = React.lazy(
  () => import('./pages/admin/AuditLedgerIntegrityReport')
);
const PolicyTrainingAcknowledgmentReport = React.lazy(
  () => import('./pages/admin/PolicyTrainingAcknowledgmentReport')
);
const EdriExecutiveMatrix = React.lazy(
  () => import('./pages/admin/EdriExecutiveMatrix')
);
const SecureVaultPage = React.lazy(
  () => import('./pages/admin/SecureVaultPage')
);
const CmmcDashboard = React.lazy(() => import('./pages/admin/CmmcDashboard'));
const BusinessContinuityDashboard = React.lazy(
  () => import('./pages/admin/BusinessContinuityDashboard')
);
const IdentityMatrixPage = React.lazy(
  () => import('./pages/IdentityMatrixPage')
);
const IdentityDiagnosticPage = React.lazy(
  () => import('./pages/IdentityDiagnosticPage')
);
const ProteusLabsDashboard = React.lazy(
  () => import('./pages/proteus-labs/ProteusLabsDashboard')
);
const ProteusPromptBuilder = React.lazy(
  () => import('./pages/proteus-labs/ProteusPromptBuilder')
);
const ProteusPromptDetail = React.lazy(
  () => import('./pages/proteus-labs/ProteusPromptDetail')
);
const ProteusExecutionHistory = React.lazy(
  () => import('./pages/proteus-labs/ProteusExecutionHistory')
);
...
function ConditionalOfflineIndicator() {
  ...
  return isEmbed || location === '/admin-dashboard-preview' ? null : (
    <OfflineIndicator />
  );
}
  ...
  React.useEffect(() => {
    ...
    if (currentUser.username) {
      ...
      if (personalizedRoute !== '/') {
        console.log(
          `Redirecting ${currentUser.username} to ${personalizedRoute}`
        );
                ...
                <RouteErrorBoundary>
                    ...
                    >
                      <Switch>
                        ...
                        <Route
                          ...
                          component={DraftBOMBuilderPage}
                        />
                        <Route
                          path="/design/rd-projects"
                          component={RDProjectsPage}
                        />
                        <Route path="/rfq-builder" component={RFQBuilderPage} />
                        <Route
                          path="/rfq-builder/:id"
                          component={RFQBuilderPage}
                        />
                        <Route
                          path="/analytics"
                        ...
                        <Route
                          path="/quote-accuracy"
                          component={QuoteAccuracyDashboard}
                        />
                        <Route
                          path="/finish-qc-completed-report"
                          component={FinishQCCompletedReport}
                        />
                        <Route
                          path="/discounts"
                        ...
                        <Route
                          ...
                          component={OperatorAuthSessionsPage}
                        />
                        <Route
                        ...
                        <Route
                          ...
                          component={SystemHealthChecksPage}
                        />
                        <Route
                          path="/admin/monitored-links"
                          component={MonitoredLinksManager}
                        />
                        <Route
                        ...
                        />
                        <Route
                          path="/admin/accounting-prep"
                          component={AccountingPrepPage}
                        />
                        <Route
                          path="/admin/qr-codes"
                          component={QRCodeAdminPage}
                        />
                        <Route
                          path="/admin/checklist-management"
                          component={AdminChecklistManagementPage}
                        />
                        <Route
                          path="/production-forecast"
                          component={ProductionForecastPage}
                        />
                        <Route
                          path="/production-forecast/settings"
                          component={ForecastSettings}
                        />
                        <Route
                          path="/admin/attention"
                          component={AttentionDashboard}
                        />
                        <Route
                          path="/admin/inspector/production-order"
                          component={ProductionOrderInspector}
                        />
                        <Route
                          path="/admin/domain-truth"
                          component={DomainTruthInspector}
                        />
                        <Route
                          path="/admin/queue-integrity"
                          component={QueueIntegrityMonitor}
                        />
                        <Route
                          path="/admin/shipping-status-audit"
                          component={ShippingStatusAuditPage}
                        />
                        <Route
                          path="/admin/p1-po-status-repair"
                          component={P1POStatusRepairPage}
                        />
                        <Route
                          path="/admin/control-tower"
                          component={ProductionControlTower}
                        />
                        <Route
                          path="/admin/secure-vault"
                        ...
                        <Route
                          ...
                          component={AuditLedgerPage}
                        />
                        <Route
                          path="/admin/inventory-anomalies"
                          component={InventoryAnomalyDashboard}
                        />
                        <Route
                          path="/admin/anomaly-config"
                          component={AnomalyDetectorConfigPage}
                        />
                        <Route path="/approvals" component={ApprovalsInbox} />
                        <Route
                          path="/admin/escalation-policies"
                          component={EscalationPoliciesPage}
                        />
                        <Route
                          path="/admin/locate-order"
                          component={LocateOrder}
                        />
                        ...
                        />
                        <Route
                          path="/order-timeline/:entityType/:entityId"
                        ...
                        <Route
                          ...
                          component={SignedDocumentsLibrary}
                        />
                        <Route
                          path="/signature-workflow"
                          component={SignatureWorkflowPage}
                        />
                        <Route
                          path="/reference-docs"
                          component={ReferenceDocsPage}
                        />
                        <Route
                        ...
                        />
                        <Route
                          path="/app/production/timer-history"
                          component={ProductionTimerHistory}
                        />
                        <Route
                          path="/app/production/timer-programs"
                          component={TimerProgramsPage}
                        />
                        ...
                        <Route
                          path="/tickets-command-center"
                          component={TicketsCommandCenter}
                        />
                        <Route
                        ...
                        <Route
                          ...
                          component={VendorPOComplianceBackfillPage}
                        />
                        ...
                        <Route
                          path="/pdf-templates"
                          component={PDFTemplateManager}
                        />
                        <Route
                          path="/fillable-pdf-templates"
                          component={FillablePdfTemplatesAdmin}
                        />
                        <Route
                          path="/fillable-pdf-templates/:id/editor"
                          component={VisualFieldEditor}
                        />

                        {/* PDF Forms Module */}
                        <Route path="/pdf-forms" component={PdfFormsPage} />
                        <Route
                          path="/pdf-forms/editor/:id"
                          component={PdfFormsEditorPage}
                        />
                        <Route
                          path="/pdf-forms/fill/:id"
                          component={PdfFormsFillPage}
                        />
                        ...
                        <Route
                          ...
                          component={PurchaseOrders}
                        />
                        <Route path="/p2-purchase-orders">
                          <Redirect to="/p2-control-center" />
                        </Route>
                        <Route path="/p2-department-manager">
                          <Redirect to="/p2-control-center" />
                        </Route>
                        <Route path="/po-products" component={POProductsPage} />
                        <Route
                          path="/product-labels"
                          component={ProductLabelsPage}
                        />
                  ...
                  /> */}
                        ...
                        <Route
                          ...
                          component={MaintenanceEventsPage}
                        />
                        ...
                        <Route
                          path="/wad-wizard"
                          component={WADWizardLauncherPage}
                        />
                        <Route
                          path="/wad-status"
                          component={WADStatusDashboard}
                        />
                        ...
                        <Route path="/work-orders/:id">
                          {(params) => (
                            <ProductionWorkOrderDetailPage params={params} />
                          )}
                        </Route>
                        ...
                        <Route
                          ...
                          component={QMSPartsEquipmentPage}
                        />
                        <Route
                          path="/qms/design-control"
                          component={QMSDesignControlPage}
                        />
                        <Route
                          path="/qms/as9100-audit-readiness"
                          component={AS9100AuditReadinessPage}
                        />
                        <Route
                          path="/qms/epoch-software-validation"
                          component={EpochSoftwareValidationPage}
                        />
                        ...
                        />
                        <Route
                          path="/onboarding/paths"
                          component={OnboardingPathsPage}
                        />
                        <Route
                        ...
                        />
                        <Route
                          path="/onboarding/employer-signatures"
                          component={EmployerSignaturesPage}
                        />
                        {/* DEPRECATED: Form builder hidden - using fixed demographics instead */}
                        {/* <Route path="/onboarding/forms" component={OnboardingFormsPage} /> */}
                        <Route
                          path="/onboarding/session/:id"
                          component={OnboardingSessionWizard}
                        />
                        <Route
                        ...
                        <Route
                          ...
                          component={ProductionControlCenter}
                        />
                        <Route
                          path="/production-control-center-live"
                          component={ProductionControlCenterLive}
                        />
                        <Route
                          path="/daily-throughput-board"
                          component={DailyThroughputBoard}
                        />
                        <Route
                          path="/ag-dashboard"
                          component={AGTestDashboard}
                        />
                        <Route
                        ...
                        />
                        <Route
                          path="/blaket-dashboard"
                          component={BLAKETDashboard}
                        />
                        <Route
                          path="/jessicap-dashboard"
                          component={JESSICAPDashboard}
                        />
                        <Route
                          path="/brian-dashboard"
                          component={BRIANDashboard}
                        />
                        <Route
                          path="/tomasm-dashboard"
                          component={TOMASMDashboard}
                        />
                        <Route
                        ...
                        <Route
                          path="/cutting-control-center/:rest*"
                          component={CuttingControlCenterLayout}
                        />
                        <Route
                          path="/cutting-control-center"
                          component={CuttingControlCenterLayout}
                        />
                        <Route path="/cutting-table">
                          <Redirect to="/cutting-control-center" />
                        </Route>
                        <Route path="/cutting-dashboard">
                          <Redirect to="/cutting-control-center" />
                        </Route>
                        <Route
                          path="/fabric-inventory"
                          component={FabricInventoryPage}
                        />

                        {/* Employee Badge Routes */}
                        <Route
                          path="/badge-configuration"
                          component={EmployeeBadgeConfiguration}
                        />
                        ...
                        {/* Business Review */}
                        <Route
                          path="/business-review/sessions/:monthKey"
                          component={FinancialReviewSlidePage}
                        />
                        <Route
                          path="/business-review/sessions"
                          component={FinancialReviewListPage}
                        />
                        <Route
                          path="/business-review"
                          component={FinancialReviewPage}
                        />
                        <Route
                          path="/finance/ap-journal"
                          component={APJournalPage}
                        />
                        <Route
                          path="/finance/ar-journal"
                          component={ARJournalPage}
                        />
                        <Route
                        ...
                        <Route
                          ...
                          component={P2OrderGuide}
                        />
                        <Route
                          path="/help/timeclock-training-program"
                          component={TimeclockTrainingProgramGuide}
                        />
                        <Route
                          path="/help/pto-request-guide"
                          component={PTORequestGuide}
                        />
                        <Route
                          path="/help/punch-edit-request-guide"
                          component={PunchEditRequestGuide}
                        />
                        <Route
                          path="/help/timesheet-review-guide"
                          component={TimesheetReviewGuide}
                        />
                        ...
                        <Route
                          path="/reports/po-production-orders"
                          component={POProductionOrdersReport}
                        />
                        <Route
                        ...
                        <Route
                          ...
                          component={P2ControlCenter}
                        />
                        <Route
                          path="/p2-customers"
                          component={P2CustomersPage}
                        />
                        <Route path="/p2-forms" component={P2Forms} />
                        <Route path="/p2-traveler" component={P2TravelerPage} />
                        <Route
                          path="/p2-traveler-viewer"
                          component={P2TravelerViewer}
                        />
                        <Route
                          path="/p2/packing-slip/:id"
                          component={P2PackingSlipViewer}
                        />
                        <Route
                          path="/p2/purchase-orders/:id/preview"
                          component={P2POViewer}
                        />
                        <Route path="/p2/rma/:id" component={P2RmaDetailPage} />
                        <Route
                          path="/p2/certificate/:id"
                          component={P2CertificateViewer}
                        />
                        <Route
                          path="/p2/shipments"
                          component={P2ShipmentHistory}
                        />
                        <Route
                          path="/p2/shipments/:lotId"
                          component={P2ShipmentDetail}
                        />
                        <Route
                          path="/p2/material-transfer"
                          component={P2MaterialTransferForm}
                        />
                        <Route
                          path="/p2/ready-to-ship"
                          component={P2ReadyToShipDashboard}
                        />
                        <Route
                          path="/p2/test-report/:id"
                          component={P2TestReportViewer}
                        />
                        ...
                        <Route
                          ...
                          component={SubAssemblyQueue}
                        />
                        <Route
                          path="/assembly-queue"
                          component={AssemblyQueue}
                        />
                        <Route path="/cutting-table-mfg-queue">
                          <Redirect to="/cutting-control-center" />
                        </Route>
                        <Route path="/part-routing-management">
                          <Redirect to="/p2-control-center" />
                        </Route>
                        ...
                        <Route
                          path="/travelers/:id"
                          component={TravelerExecution}
                        />
                        <Route
                          path="/travelers/:id/execute"
                          component={TravelerExecution}
                        />
                        ...
                        <Route
                          ...
                          component={InventoryRestockSignalsPage}
                        />
                        <Route
                        ...
                        <Route
                          ...
                          component={PreproductionChecklistPage}
                        />
                        <Route
                          path="/pm-control-center"
                          component={PMControlCenterPage}
                        />
                        <Route path="/projects" component={ProjectsPage} />
                        <Route
                          path="/projects/pipeline"
                          component={P2PipelineBoardPage}
                        />
                        <Route
                          path="/projects/:id/closing"
                          component={ProjectClosingRecordPage}
                        />
                        <Route
                          path="/projects/:id"
                        ...
                        />
                        <Route path="/anodize-jobs" component={AnodizeJobs} />
                        <Route
                        ...
                        <Route
                          ...
                          component={TrainingControlCenter}
                        />
                        <Route path="/training">
                          <Redirect to="/training/my-training" />
                        </Route>
                        <Route path="/training-management">
                          <Redirect to="/training-control-center" />
                        </Route>
                        <Route path="/training-matrix">
                          <Redirect to="/training-control-center" />
                        </Route>
                        <Route path="/training-matrix-import">
                          <Redirect to="/training-control-center" />
                        </Route>
                        <Route path="/training-matrix-manage">
                          <Redirect to="/training-control-center" />
                        </Route>
                        <Route
                        ...
                        <Route
                          ...
                          component={TraineeTrainingPortal}
                        />
                        <Route
                          path="/training/work-instructions"
                          component={WorkInstructionsPage}
                        />
                        <Route
                        ...
                        />
                        <Route
                          path="/training/daily-quizzes"
                          component={DailyQuizSelectionPage}
                        />
                        <Route
                          path="/training/assign"
                          component={AssignProgramPage}
                        />
                        <Route
                          path="/training/sessions/:sessionId"
                          component={SessionDailySheetPage}
                        />
                        <Route
                          path="/training/content-library"
                          component={TrainingContentLibrary}
                        />
                        <Route
                        ...
                        />
                        <Route path="/p2-serialized-scheduler">
                          <Redirect to="/p2-control-center" />
                        </Route>
                        <Route
                        ...
                        <Route
                          ...
                          component={ShippingTracker}
                        />
                        <Route
                          path="/weekly-shipments"
                          component={RedirectToShippingTracker}
                        />
                        <Route
                        ...
                        />
                        <Route
                          path="/metrics-sandbox"
                          component={MetricsSandbox}
                        />
                        <Route
                          path="/metric-directory"
                          component={MetricDirectory}
                        />
                        <Route
                          path="/identity-matrix"
                          component={IdentityMatrixPage}
                        />
                        <Route
                          path="/admin/identity-diagnostic"
                          component={IdentityDiagnosticPage}
                        />
                        <Route
                          path="/past-due-report"
                          component={PastDueReport}
                        />
                        <Route
                          path="/what-if-forecast"
                          component={WhatIfForecast}
                        />
                        ...
                        <Route
                          path="/cnc-dashboard"
                          component={CNCDashboardPage}
                        />
                        <Route
                          path="/cnc/batch-station"
                          component={CNCOperationBatchStation}
                        />
                        <Route
                          path="/cnc-part-routings"
                          component={CNCPartRoutingsPage}
                        />
                        <Route
                        ...
                        <Route
                          path="/admin/edri/heatmap"
                          component={EdriHeatmap}
                        />
                        <Route
                          path="/admin/edri/red-flags"
                          component={EdriRedFlags}
                        />
                        <Route
                          path="/admin/edri/remediation"
                          component={EdriRemediation}
                        />
                        <Route
                          path="/admin/edri/missing-evidence"
                          component={EdriMissingEvidence}
                        />
                        <Route
                          path="/admin/edri/history"
                          component={EdriHistory}
                        />
                        <Route
                          path="/admin/edri/charge-code-usage"
                          component={ChargeCodeUsageReport}
                        />
                        <Route
                          path="/admin/edri/labor-distribution"
                          component={LaborDistributionReport}
                        />
                        <Route
                          path="/admin/edri/transaction-evidence-map"
                          component={TransactionEvidenceMap}
                        />
                        <Route
                          path="/admin/edri/supervisor-approval-exceptions"
                          component={SupervisorApprovalExceptionReport}
                        />
                        <Route
                          path="/admin/edri/timesheet-correction-log"
                          component={TimesheetCorrectionLogReport}
                        />
                        <Route
                          path="/admin/edri/payroll-export-reconciliation"
                          component={PayrollExportReconciliationReport}
                        />
                        <Route
                          path="/admin/edri/indirect-cost-burden-rates"
                          component={IndirectCostBurdenRateReport}
                        />
                        <Route
                          path="/admin/edri/unallowable-cost-review"
                          component={UnallowableCostReviewReport}
                        />
                        <Route
                          path="/admin/edri/procurement-compliance"
                          component={ProcurementComplianceReport}
                        />
                        <Route
                          path="/admin/edri/inventory-traceability"
                          component={InventoryTraceabilityReport}
                        />
                        <Route
                          path="/admin/edri/audit-ledger-integrity"
                          component={AuditLedgerIntegrityReport}
                        />
                        <Route
                          path="/admin/edri/policy-training-acknowledgment"
                          component={PolicyTrainingAcknowledgmentReport}
                        />
                        <Route
                          path="/admin/edri/supporting-docs"
                          component={EdriSupportingDocs}
                        />
                        <Route
                          path="/admin/edri/domain/:domainKey"
                          component={EdriDomainDetail}
                        />
                        <Route
                          path="/admin/edri/snapshot/:snapshotId/evidence/:domainKey"
                          component={EdriEvidence}
                        />
                        <Route
                          path="/admin/edri/snapshot/:snapshotId/evidence"
                          component={EdriEvidence}
                        />
                        <Route
                          path="/admin/edri/executive-matrix"
                          component={EdriExecutiveMatrix}
                        />
                        <Route
                          path="/admin/edri/snapshot/:snapshotId"
                          component={EdriSnapshotDetail}
                        />
                        <Route
                          path="/admin/dcaa-findings"
                          component={DcaaFindings}
                        />
                        <Route
                        ...
                        <Route
                          path="/admin/continuity"
                          component={BusinessContinuityDashboard}
                        />
                        {/* Prompt Library (ADMIN/OWNER only) */}
                        <Route
                          path="/prompt-library"
                          component={ProteusLabsDashboard}
                        />
                        <Route
                          path="/prompt-library/new"
                          component={ProteusPromptBuilder}
                        />
                        <Route
                          path="/prompt-library/history"
                          component={ProteusExecutionHistory}
                        />
                        <Route
                        ...
                        <Route
                          ...
                          component={ProteusPromptDetail}
                        />
                        <Route path="/proteus-labs">
                          <Redirect to="/prompt-library" />
                        </Route>
                        <Route path="/proteus-labs/new">
                          <Redirect to="/prompt-library/new" />
                        </Route>
                        <Route path="/proteus-labs/history">
                          <Redirect to="/prompt-library/history" />
                        </Route>
                        <Route path="/proteus-labs/:id/edit">
                          {(params) => (
                            <Redirect
                              to={`/prompt-library/${params.id}/edit`}
                            />
                          )}
                        </Route>
                        <Route path="/proteus-labs/:id">
                          {(params) => (
                            <Redirect to={`/prompt-library/${params.id}`} />
                          )}
                        </Route>

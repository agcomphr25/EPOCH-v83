  ...
  return (
    <div className="container mx-auto p-6">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Welcome, ANGIET</h1>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link href="/all-orders"><Button className="w-full h-12" variant="outline" data-testid="button-quick-all-orders"><List className="h-4 w-4 mr-2" />View All Orders</Button></Link>

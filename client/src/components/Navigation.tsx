...
export default function Navigation() {
  ...
  const qmsItems: NavItemDef[] = [
    ...
    },
    {
      ...
      label: 'Equipment TAB 1',
      icon: PackageCheck,
      description: 'Equipment register import and maintenance records',
    },
    {
      path: '/qms/parts-equipment?tab=measuring-devices',
      label: 'Measuring Device List',
      icon: PackageCheck,
      description: 'Measuring device inspection and calibration schedule',
    },
    {
      path: '/qms/parts-equipment?tab=as9100-calibration',
      label: 'AS9100 Calibration TAB 2',
      icon: PackageCheck,
      description: 'AS9100 calibration records and next due dates',
    },
    {
      path: '/qms/parts-equipment?tab=as9100-validation',
      label: 'AS9100 Validation TAB 3',
      icon: PackageCheck,
      description: 'AS9100 validation assets and audit records',
    },
    {
      path: '/qms/parts-equipment?tab=customer-property',
      label: 'Customer Property TAB 4',
      icon: PackageCheck,
      description: 'Customer-owned property inventory and validation records',
    },
    {
      path: '/qms/parts-equipment?tab=serialized-items',
      label: 'Serialized Items TAB 5',
      icon: PackageCheck,
      description: 'Serialized controlled items and quarterly inventories',
    },
    {
      path: '/qms/parts-equipment?tab=returned-items',
      label: 'Returned Items TAB 6',
      icon: PackageCheck,
      description: 'Returned customer and controlled items',
    },
    {
      path: '/qms/parts-equipment?tab=calibration-archive',
      label: 'Calibration Register (ARCHIVE)',
      icon: PackageCheck,
      description: 'Historical calibration register events',
    },
    {
      path: '/assets',
      label: 'Assets',

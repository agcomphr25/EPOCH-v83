...
CREATE TABLE "customer_satisfaction_responses" (
	"id" integer PRIMARY KEY DEFAULT nextval('customer_satisfaction_responses_id_seq') NOT NULL,
...
CREATE TABLE "customer_satisfaction_surveys" (
	"id" integer PRIMARY KEY DEFAULT nextval('customer_satisfaction_surveys_id_seq') NOT NULL,
	"title" text NOT NULL,
	"description" text,
	"is_active" boolean DEFAULT true,

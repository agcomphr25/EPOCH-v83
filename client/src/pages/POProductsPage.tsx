...
export default function POProductsPage() {
  ...
  const createMutation = useMutation({
    mutationFn: async (
      data: Omit<POProduct, 'id' | 'isActive' | 'createdAt' | 'updatedAt'>
    ) => {
                ...
                {poProducts.map((product) => (
                  <TableRow key={product.id}>
                    ...
                    <TableCell data-testid={`text-stock-model-${product.id}`}>
                      {stockModels.find((sm) => sm.id === product.stockModel)
                        ?.displayName ||
                        product.stockModel ||
                        '-'}
                    </TableCell>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleInputChange('handedness', value)
                        }
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleInputChange('stockModel', value)
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleInputChange('swivelStuds', value)
                        }
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleInputChange('paintOptions', value)
                        }
                        disabled={featuresLoading}
                      >
                      ...
                      <div className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          onCheckedChange={(checked) =>
                            handleInputChange('flatTop', checked as boolean)
                          }
